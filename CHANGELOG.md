...
## [2026-07-25] — autonomous refresh-all [WARN: cumulative provenance coverage 60.6% below 85% target] [WARN: runMetadata missing fields ['toolCallCount', 'fetchAttemptCount', 'batchCount']] [partial: gap-gen supplement: agent found 468 new fills; 2 cells auto-gapped by orchestrator; 1065 explicit agent gaps preserved]

[fillRatio:0.61 cells:1171/1932 contradictions:87 fetch:0.0min tools:None batches:None build:3c0fe42]

### Updated
- 33 models: `glm-4-5-air`, `ministral-3-14b`, `muse-spark`, `opus-4-7`, `minimax-m2-5`, `deepseek-v4-pro`, `gemini-3-5-flash-lite`, `claude-sonnet-5`, `step-3-7-flash`, `gemma-4-31b`, `llama-4-scout`, `mimo-v2-5-pro`, `step-3-5-flash`, `gpt-5-6-terra`, `kimi-k2-6`, `qwen25-coder-7b`, `glm-5-turbo`, `qwen25-coder-32b`, `qwen3-coder-next`, `llama-4-maverick`, `gemini-3-1-flash-lite`, `glm-5-2`, `gemma-3-27b`, `gemini-3-5-flash`, `gemma-4-e2b`, `deepseek-v4-flash`, `gpt-5-6-sol`, `gemini-3-6-flash`, `gpt-5-6-luna`, `minimax-m3`, `grok-4-3`, `glm-4-7`, `ling-2-6-1t`
...
- `grok-3` — vendor-marked deprecated

### Resolved (auto via trustScore)
- ring-2-6-1t.tau2: winner={'value': 95.32, 'trustScore': 0.3413, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-07-25'} (severity=yellow, ΔNone)
- ling-2-6-1t.aaIdx: winner={'value': 26.0, 'trustScore': 0.4989, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- opus-4-7.aaIdx: winner={'value': 57.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-25'} (severity=yellow, ΔNone)
- gemma-4-26b-moe.tau2: winner={'value': 85.5, 'trustScore': 0.3955, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-26b-moe.sweV: winner={'value': 64.0, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-3-27b.cfElo: winner={'value': 110.0, 'trustScore': 0.3443, 'tier': 'S', 'verifications': 6, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
...
- gemini-3-1-flash-lite.gpqa: winner={'value': 86.9, 'trustScore': 0.3456, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-07-25'} (severity=yellow, ΔNone)
...
- gemini-3-1-flash-lite.swePro: winner={'value': 54.2, 'trustScore': 0.196, 'tier': 'C', 'verifications': 1, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- codestral.swePro: winner={'value': 2.0, 'trustScore': 0.425, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-05-13'} (severity=red, ΔNone)
- mistral-medium-3-5.gpqa: winner={'value': 71.22, 'trustScore': 0.4014, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- mistral-medium-3-5.hle: winner={'value': 9.5, 'trustScore': 0.4192, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- mistral-medium-3-5.tbHard: winner={'value': 20.45, 'trustScore': 0.4204, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
...
- mistral-medium-3-5.aaAgentic: winner={'value': 19.0, 'trustScore': 0.4874, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- ministral-3-14b.aaAgentic: winner={'value': 2.2, 'trustScore': 0.4874, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- ministral-3-8b.aaAgentic: winner={'value': 1.24, 'trustScore': 0.4874, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- qwen3-235b.arcAgi2: winner={'value': 13.0, 'trustScore': 0.4181, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-6-max.sweV: winner={'value': 78.8, 'trustScore': 0.425, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- qwen3-6-max.tau2: winner={'value': 95.9, 'trustScore': 0.4129, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- qwen3-6-35b-moe.tau2: winner={'value': 95.3, 'trustScore': 0.4951, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- qwen3-6-27b.tau2: winner={'value': 76.8, 'trustScore': 0.4083, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-6-plus.aaAgentic: winner={'value': 27.55, 'trustScore': 0.4874, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
...
- qwen3-coder-480b.lcb: winner={'value': 68.0, 'trustScore': 0.4145, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-05-18'} (severity=red, ΔNone)
- glm-4-5-air.tb2: winner={'value': 30.0, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- glm-5.mmluPro: winner={'value': 85.7, 'trustScore': 0.4951, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-25'} (severity=yellow, ΔNone)
- glm-5.hle: winner={'value': 30.5, 'trustScore': 0.4181, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- deepseek-v3-2.tbHard: winner={'value': 32.6, 'trustScore': 0.4645, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- deepseek-v3-2.aaCoding: winner={'value': 34.6, 'trustScore': 0.4194, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- deepseek-v3-2.aaAgentic: winner={'value': 39.82, 'trustScore': 0.4143, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- deepseek-v3-2.cfElo: winner={'value': 2386.0, 'trustScore': 0.2927, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- deepseek-v4-flash.hle: winner={'value': 34.8, 'trustScore': 0.2901, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- deepseek-v4-flash.tau2: winner={'value': 95.03, 'trustScore': 0.4858, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- deepseek-v4-flash.aime26: winner={'value': 91.6, 'trustScore': 0.4173, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
- deepseek-v4-flash.aaAgentic: winner={'value': 31.06, 'trustScore': 0.4874, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- deepseek-v4-pro.tau2: winner={'value': 96.2, 'trustScore': 0.4858, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-25'} (severity=yellow, ΔNone)
- deepseek-v4-pro.aaAgentic: winner={'value': 36.36, 'trustScore': 0.4874, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- deepseek-r1-14b.hle: winner={'value': 71.5, 'trustScore': 0.4192, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- deepseek-r1-14b.mmluPro: winner={'value': 93.9, 'trustScore': 0.2858, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
- deepseek-r1-14b.aaIdx: winner={'value': 16.0, 'trustScore': 0.424, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- ministral-3-3b.gpqa: winner={'value': 35.76, 'trustScore': 0.4722, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- ministral-3-3b.lcb: winner={'value': 24.66, 'trustScore': 0.4614, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- ministral-3-3b.aaAgentic: winner={'value': 1.58, 'trustScore': 0.4874, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- gpt-5-5.mrcr: winner={'value': 74.0, 'trustScore': 0.4173, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- gpt-5-5-pro.hle: winner={'value': 43.1, 'trustScore': 0.3958, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- gpt-5-6-sol.mrcr: winner={'value': 91.5, 'trustScore': 0.4657, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- gpt-5-6-terra.mrcr: winner={'value': 89.6, 'trustScore': 0.4657, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- gpt-5-6-luna.aaCoding: winner={'value': 74.6, 'trustScore': 0.4934, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-25'} (severity=yellow, ΔNone)
- qwen3-7-max.aaAgentic: winner={'value': 30.59, 'trustScore': 0.4874, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- qwen3-7-max.sciCode: winner={'value': 53.5, 'trustScore': 0.198, 'tier': 'C', 'verifications': 1, 'latestDate': '2026-07-25'} (severity=yellow, ΔNone)
- qwen3-7-plus.aaAgentic: winner={'value': 20.81, 'trustScore': 0.4951, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- grok-4-20.arcAgi2: winner={'value': 53.3, 'trustScore': 0.4951, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- nemotron-3-nano-omni.tau2: winner={'value': 49.04, 'trustScore': 0.4919, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- step-3-7-flash.tbHard: winner={'value': 35.6, 'trustScore': 0.4945, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-25'} (severity=yellow, ΔNone)
- step-3-7-flash.tau2: winner={'value': 88.2, 'trustScore': 0.4129, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- gemini-3-6-flash.mrcr: winner={'value': 54.0, 'trustScore': 0.326, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- llama-4-scout.lcb: winner={'value': 32.8, 'trustScore': 0.4678, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- minimax-m2-5.tau2: winner={'value': 95.32, 'trustScore': 0.4858, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-25'} (severity=yellow, ΔNone)
- minimax-m2-7.tau2: winner={'value': 84.8, 'trustScore': 0.4858, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- minimax-m2-7.tbHard: winner={'value': 39.39, 'trustScore': 0.4945, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- mimo-v2-5-pro.lcb: winner={'value': 39.6, 'trustScore': 0.3413, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- mimo-v2-5.aaIdx: winner={'value': 37.0, 'trustScore': 0.4989, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-25'} (severity=yellow, ΔNone)
- kimi-k3.deepSwe: winner={'value': 67.3, 'trustScore': 0.35, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-07-25'} (severity=yellow, ΔNone)
- mimo-v2-5-pro.aaIdx: winner={'value': 53.8, 'trustScore': 0.3413, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- mimo-v2-5.aaAgentic: winner={'value': 23.71, 'trustScore': 0.4874, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
...
- gemma-4-12b.aaCoding: winner={'value': 30.96, 'trustScore': 0.4934, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- gemma-4-12b.aaAgentic: winner={'value': 7.93, 'trustScore': 0.4874, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- llama-4-maverick.lcb: winner={'value': 43.4, 'trustScore': 0.425, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- mistral-large-3.lcb: winner={'value': 34.4, 'trustScore': 0.4678, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
...
- ministral-3-8b.lcb: winner={'value': 61.6, 'trustScore': 0.3443, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- ministral-3-14b.lcb: winner={'value': 64.6, 'trustScore': 0.4678, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
...
- deepseek-v3-2.mmluPro: winner={'value': 83.71, 'trustScore': 0.4626, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- glm-4-5-air.lcb: winner={'value': 72.9, 'trustScore': 0.2927, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
- glm-4-7.lcb: winner={'value': 84.9, 'trustScore': 0.425, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-07-01'} (severity=yellow, ΔNone)
- qwen25-coder-32b.lcb: winner={'value': 48.69, 'trustScore': 0.3977, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen25-coder-32b.mmluPro: winner={'value': 78.2, 'trustScore': 0.4173, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen25-coder-7b.lcb: winner={'value': 12.59, 'trustScore': 0.4614, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- qwen25-coder-7b.mmluPro: winner={'value': 45.6, 'trustScore': 0.3932, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)

### Gaps (761 entries — agent:759 orchestrator:2 — see data/known-gaps.json or next refresh)
- `inkling.lcb` *(agent)*: agent surveyed; value unavailable
- `inkling.mmluPro` *(agent)*: agent surveyed; value unavailable
- `inkling.tau2` *(agent)*: agent surveyed; value unavailable
- `inkling.tbHard` *(agent)*: agent surveyed; value unavailable
- `inkling.cfElo` *(agent)*: agent surveyed; value unavailable
- `inkling.mrcr` *(agent)*: agent surveyed; value unavailable
- `glm-5-2.deepSwe` *(orchestrator)*: not reached in agent survey cycle; DeepSWE data unavailable
- `muse-spark.mmluPro` *(orchestrator)*: not reached in agent survey cycle; MMLU-Pro data unavailable
- ... and 753 more

### Chronically unfilled (665 cells across 81 models — agent has actively researched these for 3+ consecutive cycles with no result)
...
- `claude-mythos-preview`: `aaAgentic`, `aaCoding`, `aaIdx`, `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `mcpA`, `mrcr`, `nl2Repo`, `tbHard`
...
- `gemini-3-flash-preview`: `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`, `swePro`
...
- `gemma-4-26b-moe`: `aaOmni`, `arcAgi2`, `bfcl`, `browseComp`, `mcpA`, `nl2Repo`, `sweMulti`, `swePro`
...
- `gpt-5-6-sol`: `aaOmni`, `aime26`, `bfcl`, `cfElo`, `hle`, `mcpA`, `mmluPro`, `nl2Repo`, `sweMulti`
- `gpt-5-6-terra`: `aaOmni`, `aime26`, `bfcl`, `cfElo`, `hle`, `mcpA`, `mmluPro`, `nl2Repo`, `sweMulti`, `sweV`, `tau2`
...
- `grok-4-5`: `aaOmni`, `aime26`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mmluPro`, `mrcr`, `nl2Repo`, `sweMulti`, `tau2`, `tbHard`
