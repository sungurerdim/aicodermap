...
### Updated
- 35 models: `deepseek-v4-pro`, `qwen3-235b`, `gemma-4-e2b`, `gpt-5-4-nano`, `glm-5-1`, `qwen3-5-9b`, `mimo-v2-pro`, `mistral-large-3`, `minimax-m2-5`, `minimax-m2-1`, `sonnet-4-6`, `minimax-m2-7`, `gemini-3-1-flash`, `claude-haiku-4-5`, `opus-4-7`, `gemma-4-31b`, `grok-4-3`, `step-3-7-flash`, `qwen25-coder-7b`, `gemma-3-27b`, `glm-5`, `qwen3-32b`, `gemma-4-e4b`, `gpt-5-5`, `glm-4-7`, `qwen3-coder-next`, `qwen3-6-27b`, `qwen3-6-35b-moe`, `glm-4-5-air`, `mistral-medium-3-5`, `deepseek-v4-flash`, `muse-spark`, `mimo-v2-5`, `mimo-v2-5-pro`, `step-3-5-flash`
...
- opus-4-7.tb2: winner={'value': 69.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- opus-4-7.mcpA: winner={'value': 77.56, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
...
- sonnet-4-6.sweV: winner={'value': 79.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- sonnet-4-6.sweMulti: winner={'value': 75.9, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
...
- sonnet-4-6.tb2: winner={'value': 58.91, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- claude-haiku-4-5.gpqa: winner={'value': 67.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- claude-haiku-4-5.tau2: winner={'value': 83.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
- claude-haiku-4-5.lcb: winner={'value': 61.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- claude-haiku-4-5.tb2: winner={'value': 41.17, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- claude-haiku-4-5.aime26: winner={'value': 83.7, 'trustScore': 0.4976, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- claude-opus-4-8.hle: winner={'value': 49.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- deepseek-v3-2.cfElo: winner={'value': 2046.0, 'trustScore': 0.35, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-v3-2.sweMulti: winner={'value': 57.87, 'trustScore': 0.35, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-v3-2.tb2: winner={'value': 46.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
- deepseek-v3-2.browseComp: winner={'value': 40.1, 'trustScore': 0.35, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-v4-pro.sweV: winner={'value': 80.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-v4-pro.swePro: winner={'value': 55.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-v4-pro.lcb: winner={'value': 93.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- gemini-3-1-flash.hle: winner={'value': 34.55, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemini-3-1-flash.sweV: winner={'value': 78.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemini-3-1-flash.lcb: winner={'value': 90.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemini-3-1-flash.aaIdx: winner={'value': 71.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- gemini-3-1-flash.tau2: winner={'value': 71.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemini-3-1-flash.aime26: winner={'value': 97.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- gemini-3-1-pro.gpqa: winner={'value': 94.25, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- gemini-3-1-pro.mmluPro: winner={'value': 90.99, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
...
- gemma-3-27b.tau2: winner={'value': 6.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- gemma-4-26b-moe.gpqa: winner={'value': 82.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemma-4-26b-moe.cfElo: winner={'value': 2150.0, 'trustScore': 0.2916, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
- gemma-4-26b-moe.mmluPro: winner={'value': 82.77, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- gemma-4-26b-moe.tau2: winner={'value': 86.4, 'trustScore': 0.35, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemma-4-26b-moe.sweV: winner={'value': 64.0, 'trustScore': 0.4737, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
...
- gemma-4-e2b.gpqa: winner={'value': 43.4, 'trustScore': 0.35, 'tier': 'S', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemma-4-e2b.aime26: winner={'value': 37.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- gemma-4-e4b.mmluPro: winner={'value': 69.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemma-4-e4b.gpqa: winner={'value': 58.6, 'trustScore': 0.4742, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- llama-4-maverick.lcb: winner={'value': 43.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- llama-4-maverick.sweV: winner={'value': 76.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
- llama-4-maverick.mmluPro: winner={'value': 80.5, 'trustScore': 0.4976, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- llama-4-scout.gpqa: winner={'value': 57.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- llama-4-scout.sweV: winner={'value': 58.24, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
- llama-4-scout.aime26: winner={'value': 78.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- minimax-m2-5.hle: winner={'value': 19.37, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- minimax-m2-5.swePro: winner={'value': 55.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- minimax-m2-7.swePro: winner={'value': 56.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- minimax-m2-1.sweMulti: winner={'value': 49.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- minimax-m2-1.lcb: winner={'value': 86.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
- minimax-m2-1.browseComp: winner={'value': 47.4, 'trustScore': 0.3394, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- minimax-m3.mmluPro: winner={'value': 84.22, 'trustScore': 0.2606, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mistral-large-3.gpqa: winner={'value': 43.9, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- devstral-2.tb2: winner={'value': 18.9, 'trustScore': 0.4976, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-05-11'} (severity=red, ΔNone)
...
- codestral.lcb: winner={'value': 37.6, 'trustScore': 0.4918, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- devstral-small-2.tb2: winner={'value': 32.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mistral-medium-3-5.sweV: winner={'value': 77.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mistral-medium-3-5.aaCoding: winner={'value': 33.12, 'trustScore': 0.4968, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- mistral-medium-3-5.aaAgentic: winner={'value': 34.89, 'trustScore': 0.4924, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mistral-medium-3-5.tau2: winner={'value': 91.4, 'trustScore': 0.4737, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mistral-small-4.gpqa: winner={'value': 71.2, 'trustScore': 0.35, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- nemotron-3-super.sweV: winner={'value': 60.47, 'trustScore': 0.5, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- nemotron-3-super.gpqa: winner={'value': 79.25, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- nemotron-3-super.lcb: winner={'value': 81.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- nemotron-3-super.tbHard: winner={'value': 29.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- nemotron-3-super.tb2: winner={'value': 29.0, 'trustScore': 0.4864, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-11'} (severity=yellow, ΔNone)
- nemotron-3-ultra.hle: winner={'value': 26.7, 'trustScore': 0.4973, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- nemotron-3-ultra.tb2: winner={'value': 56.4, 'trustScore': 0.4976, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- nemotron-3-nano-omni.gpqa: winner={'value': 72.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- nemotron-3-nano-omni.tau2: winner={'value': 42.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- gpt-4-1.sweV: winner={'value': 54.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gpt-4-1.gpqa: winner={'value': 66.46, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gpt-4-1.mmluPro: winner={'value': 80.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- gpt-5-4.gpqa: winner={'value': 92.34, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- gpt-5-5.swePro: winner={'value': 58.51, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gpt-5-5.sweV: winner={'value': 88.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- gpt-5-5.aaIdx: winner={'value': 59.92, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gpt-5-5.tau2: winner={'value': 98.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- gpt-5-4-mini.hle: winner={'value': 41.5, 'trustScore': 0.1943, 'tier': 'C', 'verifications': 1, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- gpt-5-4-nano.hle: winner={'value': 26.5, 'trustScore': 0.4973, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gpt-5-4-nano.tau2: winner={'value': 76.0, 'trustScore': 0.4923, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gpt-5-4-nano.aaAgentic: winner={'value': 59.2, 'trustScore': 0.4924, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-27b.sweV: winner={'value': 77.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-27b.swePro: winner={'value': 53.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-27b.lcb: winner={'value': 83.9, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-27b.gpqa: winner={'value': 87.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-max.gpqa: winner={'value': 86.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-05-27'} (severity=yellow, ΔNone)
- qwen3-6-max.sweV: winner={'value': 70.87, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
...
- qwen3-32b.mmluPro: winner={'value': 79.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-35b-moe.swePro: winner={'value': 49.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-35b-moe.tb2: winner={'value': 51.5, 'trustScore': 0.35, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-35b-moe.lcb: winner={'value': 80.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- qwen3-6-35b-moe.gpqa: winner={'value': 86.0, 'trustScore': 0.35, 'tier': 'S', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-35b-moe.hle: winner={'value': 20.16, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- qwen3-6-plus.swePro: winner={'value': 56.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-plus.aaIdx: winner={'value': 50.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-coder-480b.sweV: winner={'value': 69.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-coder-480b.swePro: winner={'value': 38.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-coder-30b.sweV: winner={'value': 51.22, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- qwen3-coder-next.lcb: winner={'value': 68.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen25-coder-32b.sweV: winner={'value': 69.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
- qwen25-coder-32b.gpqa: winner={'value': 41.72, 'trustScore': 0.4662, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen25-coder-32b.lcb: winner={'value': 48.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen25-coder-14b.gpqa: winner={'value': 32.8, 'trustScore': 0.4906, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- qwen25-coder-14b.lcb: winner={'value': 37.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen25-coder-7b.lcb: winner={'value': 37.6, 'trustScore': 0.35, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- qwen3-7-max.gpqa: winner={'value': 92.38, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
...
- qwen3-7-max.lcb: winner={'value': 90.87, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-7-plus.gpqa: winner={'value': 92.4, 'trustScore': 0.2, 'tier': 'C', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- qwen3-7-plus.sweV: winner={'value': 78.8, 'trustScore': 0.2, 'tier': 'C', 'verifications': 1, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
...
- grok-3-mini.lcb: winner={'value': 69.77, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-3-mini.gpqa: winner={'value': 79.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- grok-3-mini.aaIdx: winner={'value': 32.04, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-20.aaIdx: winner={'value': 49.07, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-20.gpqa: winner={'value': 88.02, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-20.hle: winner={'value': 24.29, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-20.tau2: winner={'value': 93.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- grok-4-20.aaCoding: winner={'value': 40.45, 'trustScore': 0.4968, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- grok-4-20.aaAgentic: winner={'value': 53.86, 'trustScore': 0.4924, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-3.gpqa: winner={'value': 90.08, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-3.hle: winner={'value': 53.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
- grok-4-3.aaAgentic: winner={'value': 65.89, 'trustScore': 0.5, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-1-fast.gpqa: winner={'value': 85.37, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- mimo-v2-5-pro.gpqa: winner={'value': 66.7, 'trustScore': 0.35, 'tier': 'S', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- mimo-v2-5-pro.aime26: winner={'value': 37.3, 'trustScore': 0.35, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
...
- mimo-v2-flash.gpqa: winner={'value': 83.83, 'trustScore': 0.5, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- mimo-v2-flash.tb2: winner={'value': 38.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mimo-v2-flash.mmluPro: winner={'value': 84.9, 'trustScore': 0.35, 'tier': 'S', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mimo-v2-flash.aaIdx: winner={'value': 30.35, 'trustScore': 0.4995, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mimo-v2-pro.aaAgentic: winner={'value': 62.8, 'trustScore': 0.4924, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mimo-v2-pro.gpqa: winner={'value': 86.95, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- mimo-v2-pro.tau2: winner={'value': 95.01, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mimo-v2-pro.sweV: winner={'value': 78.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-5-1.aaIdx: winner={'value': 51.12, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-5-1.gpqa: winner={'value': 86.26, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-5-1.hle: winner={'value': 52.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- glm-5-1.tau2: winner={'value': 97.69, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- glm-5-1.mcpA: winner={'value': 71.8, 'trustScore': 0.35, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-5.gpqa: winner={'value': 82.02, 'trustScore': 0.4662, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- glm-5.hle: winner={'value': 27.25, 'trustScore': 0.4973, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- glm-5.tau2: winner={'value': 98.25, 'trustScore': 0.4828, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- glm-4-7.browseComp: winner={'value': 67.0, 'trustScore': 0.4026, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-05-06'} (severity=red, ΔNone)
...
- glm-4-5-air.hle: winner={'value': 14.4, 'trustScore': 0.35, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-4-5-air.tau2: winner={'value': 78.18, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-4-5-air.sweV: winner={'value': 57.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-4-5-air.tb2: winner={'value': 37.5, 'trustScore': 0.3407, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-05-22'} (severity=red, ΔNone)
...
- kimi-k2-6.swePro: winner={'value': 58.6, 'trustScore': 0.4737, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- kimi-k2-6.lcb: winner={'value': 89.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- step-3-5-flash.sweV: winner={'value': 74.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- step-3-5-flash.tb2: winner={'value': 51.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- step-3-5-flash.mmluPro: winner={'value': 84.4, 'trustScore': 0.4743, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-05-22'} (severity=red, ΔNone)
- step-3-7-flash.aaCoding: winner={'value': 34.56, 'trustScore': 0.4968, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- step-3-7-flash.aaAgentic: winner={'value': 48.23, 'trustScore': 0.4924, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- step-3-7-flash.gpqa: winner={'value': 77.8, 'trustScore': 0.4875, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- deepseek-v3-2.aaIdx: winner={'value': 32.04, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-4-7.aaIdx: winner={'value': 34.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-4-7.aaCoding: winner={'value': 23.82, 'trustScore': 0.5, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-4-7.aaAgentic: winner={'value': 21.01, 'trustScore': 0.5, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
### Gaps (401 entries — agent:271 orchestrator:130 — see data/known-gaps.json or next refresh)
...
- 12 cells confirmed (un-quarantined) incl. AA-definitional `gemma-4-31b.{aaIdx,aaCoding,aaAgentic}`. 4 AA-composite misfiles corrected by `apply-aa-authoritative.py`.
- **Tooling note:** `validate-anomaly-verdicts.py` rejected 5 legit `cfElo` confirms (deepseek-v4-pro 3206, gemma-4-31b 2150, deepseek-r1-14b 1481, deepseek-v4-flash 3052, gemma-3-27b 110) using a `[0-100]` band — cfElo is Codeforces Elo (~1000-3500). Behaviour was safe (those cells stay quarantined, no corruption) but the gate's cfElo band needs widening for the un-quarantine path to work.
