...
[fillRatio:0.66 cells:1029/1564 contradictions:168 fetch:0.0min tools:None batches:None build:e373b57]

### Added
- `qwen3-5-omni-plus` (Alibaba Qwen, released 2026-03-30) — evidence: alibabacloud.com/help/en/model-studio/models
- `gemini-3-5-flash-cyber` (Google DeepMind, released 2026-07-21, limited-access security pilot) — evidence: deepmind.google/blog/introducing-gemini-3-5-flash-cyber
- `ling-3-0-flash` (inclusionai, released 2026-07-23) — evidence: designforonline.com/ai-models/ling-3-0-flash-free
- `ternary-bonsai-8b` (prismml, released 2026-04-16) — evidence: prnewswire.com/news-releases/prismml-introduces-ternary-bonsai-model-family-302745151
- 🔎 New vendor candidates: 6 this cycle (review queue; 10 pending total incl. prior cycles)
- 🔎 New benchmark candidates: 0 this cycle (5 pending total incl. prior cycles, 0 AC6-ready)

### Updated
- 54 models: `deepseek-v4-flash`, `qwen25-coder-7b`, `nemotron-3-nano`, `gemma-4-26b-moe`, `qwen25-coder-32b`, `kimi-k3`, `gemini-3-6-flash`, `gemini-3-1-flash-lite`, `qwen3-5-omni-plus`, `claude-haiku-4-5`, `claude-fable-5`, `qwen3-32b`, `glm-4-5-air`, `qwen3-coder-next`, `llama-4-scout`, `gpt-5-6-luna`, `inkling`, `glm-4-7`, `minimax-m3`, `claude-opus-4-8`, `ling-3-0-flash`, `ling-2-6-1t`, `grok-4-5`, `glm-5`, `gemini-3-1-flash`, `qwen3-coder-30b`, `kimi-k2-7-code`, `mistral-large-3`, `grok-4-3`, `qwen3-5-9b`, `muse-spark`, `glm-5-turbo`, `mimo-v2-5-pro`, `gemini-3-1-pro`, `qwen3-7-max`, `gpt-5-6-terra`, `gpt-5-6-sol`, `llama-4-maverick`, `glm-5-2`, `qwen3-235b`, `gemini-3-5-flash-lite`, `ministral-3-14b`, `gemma-4-31b`, `qwen3-6-27b`, `step-3-7-flash`, `step-3-5-flash`, `grok-4-20`, `kimi-k2-6`, `mimo-v2-5`, `opus-4-7`, `gemini-3-flash-preview`, `claude-opus-5`, `gemma-3-27b`, `codestral`
...
- opus-4-7.sweV: winner={'value': 87.6, 'trustScore': 0.425, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- opus-4-7.gpqa: winner={'value': 94.2, 'trustScore': 0.4659, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- opus-4-7.tb2: winner={'value': 69.1, 'trustScore': 0.425, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- opus-4-7.hle: winner={'value': 46.9, 'trustScore': 0.4659, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- opus-4-7.swePro: winner={'value': 64.3, 'trustScore': 0.467, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- opus-4-7.aaIdx: winner={'value': 53.53, 'trustScore': 0.4989, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- sonnet-4-6.sweV: winner={'value': 79.6, 'trustScore': 0.4591, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- sonnet-4-6.gpqa: winner={'value': 74.1, 'trustScore': 0.425, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- sonnet-4-6.tb2: winner={'value': 59.1, 'trustScore': 0.4807, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- sonnet-4-6.hle: winner={'value': 51.0, 'trustScore': 0.4933, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- sonnet-4-6.tau2: winner={'value': 87.5, 'trustScore': 0.4204, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-09'} (severity=red, ΔNone)
- sonnet-4-6.arcAgi2: winner={'value': 58.3, 'trustScore': 0.425, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- sonnet-4-6.aaIdx: winner={'value': 35.89, 'trustScore': 0.4989, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- sonnet-4-6.mmluPro: winner={'value': 79.2, 'trustScore': 0.4636, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- claude-haiku-4-5.sweV: winner={'value': 73.3, 'trustScore': 0.4591, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- claude-haiku-4-5.tau2: winner={'value': 83.0, 'trustScore': 0.491, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- claude-opus-4-8.aaIdx: winner={'value': 55.69, 'trustScore': 0.4989, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- claude-opus-4-8.tb2: winner={'value': 74.6, 'trustScore': 0.491, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- claude-fable-5.lcb: winner={'value': 89.78, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-mythos-5.sweV: winner={'value': 93.9, 'trustScore': 0.4591, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- claude-sonnet-5.aaIdx: winner={'value': 53.0, 'trustScore': 0.4989, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- claude-opus-5.tb2: winner={'value': 84.64, 'trustScore': 0.5, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- claude-opus-5.hle: winner={'value': 52.59, 'trustScore': 0.4933, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- muse-spark.hle: winner={'value': 39.9, 'trustScore': 0.4933, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- kimi-k2-6.aaCoding: winner={'value': 61.8, 'trustScore': 0.4946, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- kimi-k2-7-code.hle: winner={'value': 32.8, 'trustScore': 0.4587, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- kimi-k2-7-code.sweV: winner={'value': 78.2, 'trustScore': 0.2, 'tier': 'C', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k3.hle: winner={'value': 56.0, 'trustScore': 0.4587, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemini-3-1-flash.sweV: winner={'value': 78.0, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- gemini-3-1-flash.gpqa: winner={'value': 90.4, 'trustScore': 0.4001, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- gemini-3-1-flash.aaIdx: winner={'value': 71.0, 'trustScore': 0.4989, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- gemini-3-1-flash.hle: winner={'value': 35.0, 'trustScore': 0.4193, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- gemini-3-1-pro.gpqa: winner={'value': 94.1, 'trustScore': 0.425, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- gemini-3-1-pro.aaIdx: winner={'value': 57.02, 'trustScore': 0.424, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- gemini-3-1-pro.swePro: winner={'value': 54.2, 'trustScore': 0.425, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-3-27b.gpqa: winner={'value': 42.4, 'trustScore': 0.414, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-3-27b.lcb: winner={'value': 29.1, 'trustScore': 0.4204, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-4-26b-moe.gpqa: winner={'value': 82.3, 'trustScore': 0.487, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-4-26b-moe.aaIdx: winner={'value': 31.0, 'trustScore': 0.424, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemma-4-26b-moe.cfElo: winner={'value': 1718.0, 'trustScore': 0.3964, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-4-26b-moe.tau2: winner={'value': 85.5, 'trustScore': 0.3964, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-31b.gpqa: winner={'value': 84.3, 'trustScore': 0.425, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-4-31b.hle: winner={'value': 22.95, 'trustScore': 0.4193, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-10'} (severity=red, ΔNone)
- gemma-4-e2b.gpqa: winner={'value': 43.4, 'trustScore': 0.4001, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-4-e2b.aime26: winner={'value': 37.5, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-4-e4b.gpqa: winner={'value': 58.6, 'trustScore': 0.3964, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-4-e4b.aaCoding: winner={'value': 9.39, 'trustScore': 0.4934, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- gemma-4-e4b.aaAgentic: winner={'value': 1.79, 'trustScore': 0.4875, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemini-3-flash-preview.aaIdx: winner={'value': 38.0, 'trustScore': 0.4989, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemini-3-1-flash-lite.hle: winner={'value': 16.2, 'trustScore': 0.4587, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemini-3-1-flash-lite.gpqa: winner={'value': 86.9, 'trustScore': 0.3453, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- gemini-3-1-flash-lite.tb2: winner={'value': 51.0, 'trustScore': 0.2, 'tier': 'C', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemini-3-1-flash-lite.mmluPro: winner={'value': 78.0, 'trustScore': 0.2, 'tier': 'C', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- mistral-large-3.lcb: winner={'value': 34.4, 'trustScore': 0.4686, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
...
- mistral-large-3.tau2: winner={'value': 70.2, 'trustScore': 0.4204, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- mistral-large-3.aaAgentic: winner={'value': 5.5, 'trustScore': 0.4946, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
...
- mistral-medium-3-5.gpqa: winner={'value': 71.22, 'trustScore': 0.4001, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- mistral-medium-3-5.hle: winner={'value': 9.5, 'trustScore': 0.4193, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- mistral-medium-3-5.tbHard: winner={'value': 20.45, 'trustScore': 0.4205, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- mistral-medium-3-5.tau2: winner={'value': 91.4, 'trustScore': 0.4204, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- ministral-3-14b.lcb: winner={'value': 64.6, 'trustScore': 0.4686, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- ministral-3-14b.aaAgentic: winner={'value': 2.2, 'trustScore': 0.4875, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- ministral-3-8b.lcb: winner={'value': 61.6, 'trustScore': 0.3445, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- codestral.sweV: winner={'value': 76.2, 'trustScore': 0.425, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- codestral.gpqa: winner={'value': 78.6, 'trustScore': 0.4001, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- codestral.mmluPro: winner={'value': 24.0, 'trustScore': 0.4174, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- qwen3-6-27b.gpqa: winner={'value': 87.8, 'trustScore': 0.4601, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-6-27b.lcb: winner={'value': 83.9, 'trustScore': 0.4946, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-6-max.gpqa: winner={'value': 86.0, 'trustScore': 0.4001, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- qwen3-6-max.lcb: winner={'value': 77.8, 'trustScore': 0.3983, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-6-max.tb2: winner={'value': 65.4, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)
- qwen3-6-max.hle: winner={'value': 51.0, 'trustScore': 0.4193, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-235b.gpqa: winner={'value': 81.1, 'trustScore': 0.4069, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- qwen3-235b.lcb: winner={'value': 74.1, 'trustScore': 0.4921, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-235b.hle: winner={'value': 42.0, 'trustScore': 0.4193, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-32b.lcb: winner={'value': 54.54, 'trustScore': 0.4183, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-32b.mmluPro: winner={'value': 79.1, 'trustScore': 0.4174, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- qwen3-32b.tbHard: winner={'value': 3.03, 'trustScore': 0.4946, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- qwen3-6-35b-moe.gpqa: winner={'value': 86.0, 'trustScore': 0.4601, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- qwen3-6-35b-moe.lcb: winner={'value': 80.4, 'trustScore': 0.4946, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- qwen3-6-35b-moe.tb2: winner={'value': 51.5, 'trustScore': 0.4807, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-6-plus.mmluPro: winner={'value': 88.5, 'trustScore': 0.4588, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- qwen3-6-plus.aime26: winner={'value': 75.3, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-6-plus.aaAgentic: winner={'value': 27.55, 'trustScore': 0.4875, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- qwen3-coder-480b.swePro: winner={'value': 38.7, 'trustScore': 0.425, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- qwen3-coder-480b.aaIdx: winner={'value': 25.0, 'trustScore': 0.424, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-05-11'} (severity=red, ΔNone)
- qwen3-coder-480b.lcb: winner={'value': 68.0, 'trustScore': 0.414, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-05-18'} (severity=red, ΔNone)
- qwen3-coder-480b.mmluPro: winner={'value': 93.4, 'trustScore': 0.4588, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-coder-480b.sweV: winner={'value': 69.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- qwen3-coder-30b.aaIdx: winner={'value': 20.0, 'trustScore': 0.424, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-05-11'} (severity=red, ΔNone)
- qwen3-coder-30b.lcb: winner={'value': 56.53, 'trustScore': 0.3983, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-coder-next.aaCoding: winner={'value': 22.89, 'trustScore': 0.4934, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-02'} (severity=red, ΔNone)
- qwen25-coder-32b.lcb: winner={'value': 48.69, 'trustScore': 0.3983, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen25-coder-7b.lcb: winner={'value': 12.59, 'trustScore': 0.4625, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- qwen25-coder-14b.mmluPro: winner={'value': 55.6, 'trustScore': 0.4636, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- glm-5.hle: winner={'value': 30.5, 'trustScore': 0.4183, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- glm-5.tau2: winner={'value': 98.2, 'trustScore': 0.4946, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- glm-5.mmluPro: winner={'value': 85.23, 'trustScore': 0.479, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- glm-5.lcb: winner={'value': 86.19, 'trustScore': 0.4921, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- glm-5.aime26: winner={'value': 92.7, 'trustScore': 0.4663, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- deepseek-v4-flash.hle: winner={'value': 34.8, 'trustScore': 0.3409, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- deepseek-v4-flash.aaAgentic: winner={'value': 31.06, 'trustScore': 0.4875, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- ministral-3-3b.gpqa: winner={'value': 35.76, 'trustScore': 0.4708, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- ministral-3-3b.lcb: winner={'value': 24.66, 'trustScore': 0.4625, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gpt-5-5.sweV: winner={'value': 88.59, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gpt-5-5.hle: winner={'value': 41.4, 'trustScore': 0.425, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gpt-5-6-sol.aaCoding: winner={'value': 80.0, 'trustScore': 0.4934, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- qwen3-5-9b.hle: winner={'value': 13.3, 'trustScore': 0.4193, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- qwen3-5-9b.tbHard: winner={'value': 24.24, 'trustScore': 0.4205, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-5-9b.lcb: winner={'value': 65.6, 'trustScore': 0.3983, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- qwen3-5-9b.aaCoding: winner={'value': 28.66, 'trustScore': 0.4934, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- qwen3-5-9b.aaAgentic: winner={'value': 7.41, 'trustScore': 0.4875, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- qwen3-7-max.aaIdx: winner={'value': 45.99, 'trustScore': 0.4989, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- qwen3-7-plus.hle: winner={'value': 34.7, 'trustScore': 0.4193, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-7-plus.lcb: winner={'value': 91.6, 'trustScore': 0.3983, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)
- grok-4-20.sweV: winner={'value': 76.7, 'trustScore': 0.4602, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- grok-4-20.gpqa: winner={'value': 88.02, 'trustScore': 0.4001, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- grok-4-20.lcb: winner={'value': 79.28, 'trustScore': 0.3983, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- grok-4-20.tb2: winner={'value': 47.1, 'trustScore': 0.4807, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- grok-4-20.hle: winner={'value': 24.29, 'trustScore': 0.4193, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- grok-4-20.swePro: winner={'value': 51.8, 'trustScore': 0.4742, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- grok-4-20.tau2: winner={'value': 93.0, 'trustScore': 0.4204, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- grok-4-20.arcAgi2: winner={'value': 53.3, 'trustScore': 0.4946, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- grok-4-3.gpqa: winner={'value': 90.1, 'trustScore': 0.4601, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- grok-4-3.hle: winner={'value': 53.0, 'trustScore': 0.491, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- grok-4-3.tbHard: winner={'value': 18.9, 'trustScore': 0.4205, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- grok-4-3.tb2: winner={'value': 68.5, 'trustScore': 0.425, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- grok-4-3.sweV: winner={'value': 79.49, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- grok-4-3.lcb: winner={'value': 79.0, 'trustScore': 0.3931, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- nemotron-3-super.sweV: winner={'value': 60.47, 'trustScore': 0.4591, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- nemotron-3-super.gpqa: winner={'value': 79.23, 'trustScore': 0.4787, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- nemotron-3-super.lcb: winner={'value': 81.19, 'trustScore': 0.4686, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- nemotron-3-super.aaIdx: winner={'value': 36.0, 'trustScore': 0.4989, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- nemotron-3-super.tau2: winner={'value': 67.8, 'trustScore': 0.4862, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- nemotron-3-super.tbHard: winner={'value': 28.96, 'trustScore': 0.4946, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- step-3-5-flash.sweV: winner={'value': 74.4, 'trustScore': 0.4602, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- step-3-5-flash.tb2: winner={'value': 51.0, 'trustScore': 0.4807, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- nemotron-3-nano-omni.lcb: winner={'value': 68.25, 'trustScore': 0.4921, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- nemotron-3-ultra.aaIdx: winner={'value': 48.0, 'trustScore': 0.4989, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- minimax-m2-5.tb2: winner={'value': 52.0, 'trustScore': 0.425, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- minimax-m2-7.tb2: winner={'value': 57.0, 'trustScore': 0.4807, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-25'} (severity=red, ΔNone)
- mimo-v2-5.tbHard: winner={'value': 41.67, 'trustScore': 0.4946, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- mimo-v2-5.aaIdx: winner={'value': 37.0, 'trustScore': 0.4989, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- mimo-v2-5-pro.gpqa: winner={'value': 66.7, 'trustScore': 0.3409, 'tier': 'S', 'verifications': 7, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- mimo-v2-5-pro.aaIdx: winner={'value': 53.8, 'trustScore': 0.3409, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- mimo-v2-5-pro.hle: winner={'value': 33.78, 'trustScore': 0.4933, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- mimo-v2-5-pro.tb2: winner={'value': 68.4, 'trustScore': 0.491, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- mimo-v2-5-pro.mmluPro: winner={'value': 68.5, 'trustScore': 0.3269, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- mimo-v2-5-pro.lcb: winner={'value': 39.6, 'trustScore': 0.3409, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- mimo-v2-5-pro.tau2: winner={'value': 94.15, 'trustScore': 0.4862, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- mimo-v2-5.aaCoding: winner={'value': 56.8, 'trustScore': 0.4934, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- mimo-v2-5.aaAgentic: winner={'value': 23.71, 'trustScore': 0.4875, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gpt-5-6-luna.aaCoding: winner={'value': 74.6, 'trustScore': 0.4934, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- gemma-4-e2b.aaCoding: winner={'value': 9.0, 'trustScore': 0.4194, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-15'} (severity=yellow, ΔNone)
- qwen3-coder-next.aaAgentic: winner={'value': 42.1, 'trustScore': 0.4875, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-12b.aaCoding: winner={'value': 30.96, 'trustScore': 0.4934, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-4-12b.aaAgentic: winner={'value': 7.93, 'trustScore': 0.4875, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- llama-4-maverick.lcb: winner={'value': 43.4, 'trustScore': 0.425, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- llama-4-scout.lcb: winner={'value': 32.8, 'trustScore': 0.3983, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v3-2.lcb: winner={'value': 74.11, 'trustScore': 0.425, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-v3-2.mmluPro: winner={'value': 83.71, 'trustScore': 0.4636, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- glm-4-5-air.lcb: winner={'value': 72.9, 'trustScore': 0.2928, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
- glm-4-7.lcb: winner={'value': 84.9, 'trustScore': 0.425, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-07-01'} (severity=yellow, ΔNone)
- qwen25-coder-32b.mmluPro: winner={'value': 78.2, 'trustScore': 0.4174, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen25-coder-7b.mmluPro: winner={'value': 45.6, 'trustScore': 0.394, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)
- glm-5.gpqa: winner={'value': 85.35, 'trustScore': 0.4787, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)

### Gaps (535 entries — agent:535 orchestrator:0 — see data/known-gaps.json or next refresh)
...
- `claude-haiku-4-5.nl2Repo` *(agent)*: agent surveyed; value unavailable
- ... and 529 more

### Chronically unfilled (674 cells across 81 models — agent has actively researched these for 3+ consecutive cycles with no result)
- `claude-fable-5`: `arcAgi2`, `bfcl`, `browseComp`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`
- `claude-haiku-4-5`: `aaOmni`, `arcAgi2`, `browseComp`, `cfElo`, `nl2Repo`
- `claude-mythos-5`: `aaAgentic`, `aaCoding`, `aaOmni`, `arcAgi2`, `bfcl`, `browseComp`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`
- `claude-mythos-preview`: `aaAgentic`, `aaCoding`, `aaIdx`, `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `lcb`, `mcpA`, `mmluPro`, `mrcr`, `nl2Repo`, `tbHard`
- `claude-opus-4-8`: `aaOmni`, `bfcl`, `cfElo`, `webDevElo`
- `claude-sonnet-5`: `aaOmni`, `aime26`, `bfcl`, `mcpA`, `mmluPro`, `mrcr`, `nl2Repo`
- `codestral`: `aaAgentic`, `aaCoding`, `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`, `tau2`, `tbHard`
- `deepseek-coder-v2-16b`: `aaOmni`, `bfcl`, `browseComp`, `mcpA`, `sweMulti`
- `deepseek-r1-14b`: `aaOmni`, `bfcl`, `browseComp`, `mcpA`, `sweMulti`
- `deepseek-v3-2`: `aaOmni`, `bfcl`, `mcpA`
- `deepseek-v4-flash`: `aaOmni`, `bfcl`
- `deepseek-v4-pro`: `aaOmni`, `bfcl`
- `gemini-3-1-flash`: `aaOmni`, `browseComp`, `cfElo`, `mcpA`, `nl2Repo`, `sweMulti`
- `gemini-3-1-flash-lite`: `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `nl2Repo`, `sweMulti`
- `gemini-3-1-pro`: `nl2Repo`, `sweMulti`
- `gemini-3-5-flash`: `aaOmni`, `aime26`, `bfcl`, `browseComp`, `cfElo`, `nl2Repo`, `sweMulti`
- `gemini-3-flash-preview`: `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`, `swePro`, `tau2`, `tbHard`
- `gemini-omni-flash`: `aaAgentic`, `aaCoding`, `aaIdx`, `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `gpqa`, `hle`, `lcb`, `mcpA`, `mmluPro`, `mrcr`, `nl2Repo`, `sweMulti`, `swePro`, `sweV`, `tau2`, `tb2`, `tbHard`
- `gemma-3-27b`: `aaOmni`, `arcAgi2`, `bfcl`, `browseComp`, `mcpA`, `nl2Repo`, `sweMulti`
- `gemma-4-12b`: `aaOmni`, `arcAgi2`, `bfcl`, `browseComp`, `mcpA`, `nl2Repo`, `sweMulti`, `swePro`, `sweV`, `tb2`
- `gemma-4-26b-moe`: `aaOmni`, `arcAgi2`, `bfcl`, `browseComp`, `mcpA`, `nl2Repo`, `sweMulti`, `swePro`, `tb2`
- `gemma-4-31b`: `aaOmni`, `bfcl`, `browseComp`, `mcpA`, `nl2Repo`, `sweMulti`
- `gemma-4-e2b`: `aaOmni`, `arcAgi2`, `bfcl`, `browseComp`, `hle`, `mcpA`, `nl2Repo`, `sweMulti`, `swePro`, `sweV`, `tb2`
- `gemma-4-e4b`: `aaOmni`, `arcAgi2`, `bfcl`, `browseComp`, `hle`, `mcpA`, `nl2Repo`, `sweMulti`, `swePro`, `sweV`, `tb2`
- `glm-4-5-air`: `arcAgi2`, `cfElo`, `mcpA`, `sweMulti`, `webDevElo`
- `glm-4-7`: `bfcl`, `cfElo`, `mcpA`, `mrcr`, `webDevElo`
- `glm-5`: `aaOmni`, `bfcl`, `cfElo`, `mrcr`
- `glm-5-2`: `bfcl`, `browseComp`, `cfElo`, `mmluPro`, `mrcr`, `sweMulti`, `sweV`, `webDevElo`
- `glm-5-turbo`: `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`, `swePro`, `sweV`, `tb2`, `webDevElo`
- `glm-5v-turbo`: `aaAgentic`, `aaCoding`, `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `lcb`, `mcpA`, `mmluPro`, `mrcr`, `nl2Repo`, `sweMulti`, `swePro`, `sweV`, `tb2`, `webDevElo`
- `gpt-5-5-pro`: `aaAgentic`, `aaCoding`, `aaOmni`, `aime26`, `bfcl`, `cfElo`, `lcb`, `mmluPro`, `nl2Repo`, `sweMulti`
- `gpt-5-6-luna`: `aaOmni`, `aime26`, `bfcl`, `cfElo`, `hle`, `lcb`, `mcpA`, `mmluPro`, `nl2Repo`, `sweMulti`, `tau2`, `tbHard`
- `gpt-5-6-sol`: `aaOmni`, `aime26`, `bfcl`, `cfElo`, `hle`, `mcpA`, `mmluPro`, `nl2Repo`, `sweMulti`, `tau2`, `tbHard`
- `gpt-5-6-terra`: `aaOmni`, `aime26`, `bfcl`, `cfElo`, `hle`, `mcpA`, `mmluPro`, `nl2Repo`, `sweMulti`, `sweV`, `tau2`, `tbHard`
- `grok-4-20`: `aaOmni`, `bfcl`, `mrcr`, `nl2Repo`, `sweMulti`
- `grok-4-20-multi-agent`: `aaOmni`, `aime26`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`, `swePro`, `tb2`
- `grok-4-3`: `aaOmni`, `arcAgi2`, `bfcl`, `browseComp`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`
- `grok-4-5`: `aaOmni`, `aime26`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mmluPro`, `mrcr`, `nl2Repo`, `sweMulti`, `sweV`, `tau2`, `tbHard`
- `grok-build-0-1`: `aaOmni`, `aime26`, `bfcl`, `browseComp`, `cfElo`, `lcb`, `mcpA`, `mmluPro`, `mrcr`, `nl2Repo`, `sweMulti`, `swePro`, `tau2`, `tbHard`
- `kimi-k2-6`: `aaOmni`, `arcAgi2`, `bfcl`, `cfElo`, `nl2Repo`
- `kimi-k2-7-code`: `aaOmni`, `aime26`, `bfcl`, `browseComp`, `cfElo`, `mrcr`, `nl2Repo`, `sweMulti`, `webDevElo`
- `kimi-k2-7-code-highspeed`: `aaAgentic`, `aaCoding`, `aaIdx`, `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `gpqa`, `hle`, `lcb`, `mcpA`, `mmluPro`, `mrcr`, `nl2Repo`, `sweMulti`, `swePro`, `sweV`, `tau2`, `tb2`, `tbHard`, `webDevElo`
- `llama-4-maverick`: `aaOmni`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `nl2Repo`, `sweMulti`
- `llama-4-scout`: `aaOmni`, `browseComp`, `cfElo`, `mcpA`, `nl2Repo`, `sweMulti`
- `mimo-v2-5`: `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mrcr`, `nl2Repo`
- `mimo-v2-5-pro`: `bfcl`, `browseComp`, `mcpA`, `nl2Repo`, `sweMulti`
- `minimax-m2-5`: `aaOmni`, `cfElo`, `mcpA`
- `minimax-m2-7`: `aaOmni`, `arcAgi2`, `bfcl`, `cfElo`, `mcpA`
- `minimax-m2-7-highspeed`: `aaAgentic`, `aaCoding`, `aaIdx`, `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `gpqa`, `hle`, `lcb`, `mcpA`, `mmluPro`, `mrcr`, `nl2Repo`, `sweMulti`, `swePro`, `sweV`, `tau2`, `tb2`, `tbHard`
- `minimax-m3`: `aaOmni`, `arcAgi2`, `bfcl`, `cfElo`, `sweMulti`
- `ministral-3-14b`: `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`, `swePro`, `sweV`, `tb2`
- `ministral-3-3b`: `aaOmni`, `bfcl`, `browseComp`, `mcpA`, `sweMulti`
- `ministral-3-8b`: `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`, `swePro`, `sweV`, `tb2`
- `mistral-large-3`: `aaOmni`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`
- `mistral-medium-3-5`: `aaOmni`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mmluPro`, `mrcr`, `nl2Repo`, `sweMulti`, `webDevElo`
- `mistral-small-4`: `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`, `swePro`, `sweV`, `tb2`, `webDevElo`
- `muse-spark`: `aaOmni`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `nl2Repo`, `sweMulti`
- `nemotron-3-nano`: `aaAgentic`, `aaOmni`, `aime26`, `arcAgi2`, `browseComp`, `cfElo`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`, `swePro`
- `nemotron-3-nano-omni`: `aaOmni`, `arcAgi2`, `browseComp`, `cfElo`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`, `swePro`, `tb2`, `webDevElo`
- `nemotron-3-super`: `aaOmni`, `arcAgi2`, `bfcl`, `cfElo`, `mcpA`, `nl2Repo`, `swePro`
- `nemotron-3-ultra`: `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `cfElo`, `mcpA`, `nl2Repo`, `swePro`
- `opus-4-7`: `bfcl`, `nl2Repo`
- `qwen25-coder-14b`: `aaIdx`, `aaOmni`, `bfcl`, `browseComp`, `hle`, `mcpA`, `sweMulti`
- `qwen25-coder-32b`: `aaOmni`, `bfcl`, `browseComp`, `mcpA`, `sweMulti`
- `qwen25-coder-7b`: `aaOmni`, `bfcl`, `browseComp`, `mcpA`, `sweMulti`
- `qwen3-235b`: `aaAgentic`, `aaCoding`, `aaOmni`, `browseComp`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`
- `qwen3-32b`: `aaOmni`, `arcAgi2`, `browseComp`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`
- `qwen3-5-9b`: `aaOmni`, `arcAgi2`, `browseComp`, `cfElo`, `mcpA`, `mrcr`, `nl2Repo`, `sweMulti`, `swePro`, `webDevElo`
- `qwen3-6-27b`: `aaOmni`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mrcr`
- `qwen3-6-35b-moe`: `aaOmni`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `mrcr`
- `qwen3-6-flash`: `aaAgentic`, `aaCoding`, `aaOmni`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mrcr`, `sweMulti`, `tbHard`
- `qwen3-6-max`: `aaOmni`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mrcr`, `sweMulti`
- `qwen3-6-plus`: `aaOmni`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `mcpA`, `mrcr`, `sweMulti`
- `qwen3-7-max`: `aaOmni`, `arcAgi2`, `browseComp`, `cfElo`
- `qwen3-7-plus`: `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `browseComp`, `cfElo`, `sweMulti`
- `qwen3-coder-30b`: `aaOmni`, `bfcl`, `browseComp`, `mcpA`, `sweMulti`
- `qwen3-coder-480b`: `aaOmni`, `browseComp`, `mcpA`, `sweMulti`
- `qwen3-coder-next`: `aaOmni`, `bfcl`, `browseComp`, `mcpA`
- `sonnet-4-6`: `bfcl`, `cfElo`, `nl2Repo`
- `step-3-5-flash`: `aaOmni`, `arcAgi2`, `bfcl`, `mcpA`, `mrcr`, `nl2Repo`
- `step-3-7-flash`: `aaOmni`, `aime26`, `arcAgi2`, `bfcl`, `cfElo`, `mcpA`, `mmluPro`, `mrcr`, `nl2Repo`

## [2026-07-24] — autonomous refresh-all [WARN: cumulative provenance coverage 67.2% below 85% target] [WARN: runMetadata missing fields ['toolCallCount', 'fetchAttemptCount', 'batchCount']] [partial: gap-gen supplement: agent found 566 new fills; 88 cells auto-gapped by orchestrator; 705 explicit agent gaps preserved]

[fillRatio:0.67 cells:1005/1496 contradictions:173 fetch:0.0min tools:None batches:None build:0b5e38e]

### Lineup sync (Step 0)
- 19/19 vendors covered (16 direct lineup-page fetch + 3 via WebSearch fallback: `thinking_machines`, `inclusionai`, `prismml` — all three have empty `urls{}` in the whitelist and should be backfilled). 8 new models admitted pre-gather (same-run bench coverage, no-defer contract): `claude-opus-5` (Anthropic, 2026-07-24), `kimi-k3` (Moonshot, 2.8T MoE, 2026-07-16), `gemini-3-6-flash` + `gemini-3-5-flash-lite` (Google, 2026-07-21), `inkling` (Thinking Machines Lab's first model, 975B MoE, 2026-07-15), `bonsai-27b` (PrismML 1-bit/ternary quant of Qwen3.6-27B, 2026-07-14), `ling-2-6-1t` + `ring-2-6-1t` (InclusionAI/Ant Group, 2026-04-29). `inkling-small` gated (insufficient evidence, single host).
- 5 deprecations: `devstral-small-2`, `mimo-v2-pro`, `mimo-v2-flash`, `mimo-v2-omni`, `grok-4-1-fast` (all vendor-confirmed with successor ids).
- 🔎 New vendor candidates: 7 this cycle (poolside, kwaipilot, tencent, deepreinforce-ai, motif-technologies, upstage, nanbeige — review queue).
- `gaps[]`: `gemini-3-1-pro` GA-vs-preview status left ambiguous (vendor page inconsistent) for human follow-up; OpenAI's GPT-4.1/o4-mini/o3 "retirement" reporting verified as ChatGPT-app-only (API unaffected) — correctly NOT recorded as a deprecation.

### Anomaly resolution (Layer-3, post-merge)
- 458 anomalies detected post-merge (peer-outlier:78 single-source:342 fresh-divergence:70 source-mismatch:6 out-of-band:3). Double-verify gate dropped 6/9 HIGH-priority cells already resolved by this cycle's own gather passes (`deepseek-v4-pro.cfElo`, `deepseek-r1-14b.cfElo`, `gemma-3-27b.cfElo`, `gemma-4-31b.cfElo`, `gemma-4-26b-moe.cfElo`, `gemma-4-e2b.cfElo`); 3 gather-untouched cells auto-dispatched to anomaly-verify and all `confirm`ed genuine against primary sources: `gemma-3-27b.lmArenaElo=1338` (Gemma 3 Technical Report, arXiv:2503.19786), `gemma-4-e4b.cfElo=940` and `gemma-4-12b.cfElo=1659` (Gemma 4 Technical Report, arXiv:2607.02770, Table 5 — clean monotonic progression by model size). No reclassify/clear needed.
- AA-authoritative pass: 4 composite-index overrides applied (aaIdx/aaCoding/aaAgentic vs `_aa-rows.json`), 3 models touched.
- `reconcile-stored-winners.py`: 17 stale single-source cells replaced by a stronger multi-source consensus (e.g. `claude-haiku-4-5.tau2` 54.7→83.0 across 6 sources, `minimax-m2-5.gpqa` 47.0→85.12 across 9 sources).

### Updated
- 58 models: `mimo-v2-5-pro`, `qwen3-7-plus`, `deepseek-v4-pro`, `minimax-m2-5`, `qwen3-6-27b`, `gemini-3-5-flash`, `glm-5-2`, `gpt-5-6-sol`, `glm-5-turbo`, `mimo-v2-5`, `minimax-m2-7`, `claude-opus-5`, `step-3-7-flash`, `gpt-5-6-luna`, `gemini-3-1-flash-lite`, `qwen3-coder-30b`, `qwen3-7-max`, `qwen25-coder-32b`, `bonsai-27b`, `claude-fable-5`, `gemma-4-e2b`, `grok-4-3`, `gemini-3-6-flash`, `minimax-m3`, `gemini-3-5-flash-lite`, `qwen3-6-plus`, `gemini-3-1-pro`, `inkling`, `llama-4-scout`, `kimi-k3`, `gemma-4-31b`, `glm-4-7`, `nemotron-3-ultra`, `kimi-k2-7-code`, `gemma-4-e4b`, `qwen3-coder-480b`, `grok-4-5`, `qwen3-5-9b`, `kimi-k2-6`, `ling-2-6-1t`, `claude-haiku-4-5`, `qwen25-coder-7b`, `gpt-5-6-terra`, `ring-2-6-1t`, `qwen3-235b`, `grok-build-0-1`, `claude-sonnet-5`, `qwen3-32b`, `gemma-3-27b`, `claude-mythos-5`, `ministral-3-3b`, `qwen3-coder-next`, `deepseek-v4-flash`, `grok-4-20`, `muse-spark`, `opus-4-7`, `llama-4-maverick`, `gemma-4-12b`
...
### Resolved (auto via trustScore)
- opus-4-7.tb2: winner={'value': 69.4, 'trustScore': 0.4919, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- opus-4-7.hle: winner={'value': 46.9, 'trustScore': 0.4679, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- opus-4-7.gpqa: winner={'value': 94.2, 'trustScore': 0.4679, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- opus-4-7.mrcr: winner={'value': 32.2, 'trustScore': 0.425, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- opus-4-7.swePro: winner={'value': 64.3, 'trustScore': 0.4738, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- opus-4-7.sweV: winner={'value': 87.6, 'trustScore': 0.425, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- sonnet-4-6.gpqa: winner={'value': 74.1, 'trustScore': 0.425, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- sonnet-4-6.tau2: winner={'value': 87.5, 'trustScore': 0.4208, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-09'} (severity=red, ΔNone)
- sonnet-4-6.tb2: winner={'value': 59.1, 'trustScore': 0.4843, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- sonnet-4-6.arcAgi2: winner={'value': 58.3, 'trustScore': 0.425, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- claude-haiku-4-5.tau2: winner={'value': 83.0, 'trustScore': 0.495, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- claude-haiku-4-5.sweV: winner={'value': 73.3, 'trustScore': 0.4673, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- claude-opus-4-8.hle: winner={'value': 49.8, 'trustScore': 0.4919, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- claude-opus-4-8.tb2: winner={'value': 74.6, 'trustScore': 0.4919, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- claude-opus-5.tb2: winner={'value': 84.64, 'trustScore': 0.5, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- glm-4-5-air.gpqa: winner={'value': 79.1, 'trustScore': 0.3751, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- glm-4-5-air.hle: winner={'value': 13.3, 'trustScore': 0.4194, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- glm-4-5-air.lcb: winner={'value': 72.9, 'trustScore': 0.2936, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
- glm-4-5-air.tau2: winner={'value': 77.9, 'trustScore': 0.4919, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- glm-4-5-air.sweV: winner={'value': 57.6, 'trustScore': 0.4673, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- glm-4-7.gpqa: winner={'value': 85.7, 'trustScore': 0.4637, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- glm-4-7.hle: winner={'value': 42.8, 'trustScore': 0.4919, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- glm-4-7.lcb: winner={'value': 84.9, 'trustScore': 0.495, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- glm-4-7.tau2: winner={'value': 87.4, 'trustScore': 0.4208, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- glm-5.hle: winner={'value': 30.5, 'trustScore': 0.4194, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- glm-5.gpqa: winner={'value': 85.35, 'trustScore': 0.4833, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- glm-5.tb2: winner={'value': 56.2, 'trustScore': 0.4843, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- glm-5.tau2: winner={'value': 97.97, 'trustScore': 0.4159, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- glm-5-2.hle: winner={'value': 40.13, 'trustScore': 0.4948, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- gemini-3-1-pro.swePro: winner={'value': 54.2, 'trustScore': 0.425, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemini-3-1-pro.gpqa: winner={'value': 94.3, 'trustScore': 0.4733, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- gemini-3-1-pro.tau2: winner={'value': 76.5, 'trustScore': 0.4208, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- gemini-3-1-pro.tbHard: winner={'value': 44.3, 'trustScore': 0.4215, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- gemma-3-27b.gpqa: winner={'value': 42.4, 'trustScore': 0.4154, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-3-27b.lcb: winner={'value': 29.1, 'trustScore': 0.4208, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-3-27b.tau2: winner={'value': 6.6, 'trustScore': 0.4194, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- gemma-4-31b.gpqa: winner={'value': 84.3, 'trustScore': 0.425, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-4-31b.tau2: winner={'value': 86.4, 'trustScore': 0.4208, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gemma-4-31b.hle: winner={'value': 22.95, 'trustScore': 0.4206, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-10'} (severity=red, ΔNone)
- gemma-4-26b-moe.cfElo: winner={'value': 1718.0, 'trustScore': 0.4023, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-4-26b-moe.gpqa: winner={'value': 82.3, 'trustScore': 0.4886, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-4-26b-moe.tau2: winner={'value': 85.5, 'trustScore': 0.4023, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-26b-moe.hle: winner={'value': 22.0, 'trustScore': 0.4206, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-e2b.aime26: winner={'value': 37.5, 'trustScore': 0.4238, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-4-e2b.gpqa: winner={'value': 43.4, 'trustScore': 0.4023, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemini-3-5-flash.aaIdx: winner={'value': 50.2, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemini-3-flash-preview.sweV: winner={'value': 78.0, 'trustScore': 0.3301, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- gemini-3-flash-preview.lcb: winner={'value': 85.59, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemini-3-flash-preview.gpqa: winner={'value': 90.4, 'trustScore': 0.4733, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemini-3-1-flash-lite.gpqa: winner={'value': 82.2, 'trustScore': 0.4637, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemini-3-1-flash-lite.lcb: winner={'value': 72.0, 'trustScore': 0.3464, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- gemini-3-1-flash-lite.aaCoding: winner={'value': 34.69, 'trustScore': 0.495, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
...
- mistral-medium-3-5.sweV: winner={'value': 77.6, 'trustScore': 0.4986, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- mistral-medium-3-5.tau2: winner={'value': 91.4, 'trustScore': 0.4208, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
...
- qwen3-6-27b.lcb: winner={'value': 83.9, 'trustScore': 0.495, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- qwen3-6-27b.gpqa: winner={'value': 87.8, 'trustScore': 0.4637, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- qwen3-6-35b-moe.gpqa: winner={'value': 86.0, 'trustScore': 0.4637, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- qwen3-6-35b-moe.lcb: winner={'value': 80.4, 'trustScore': 0.495, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- qwen3-6-35b-moe.tb2: winner={'value': 51.5, 'trustScore': 0.4843, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- qwen3-6-max.tb2: winner={'value': 65.4, 'trustScore': 0.4238, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- qwen3-235b.gpqa: winner={'value': 81.1, 'trustScore': 0.4108, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- qwen3-235b.aaIdx: winner={'value': 30.0, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-32b.gpqa: winner={'value': 54.6, 'trustScore': 0.4108, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-32b.lcb: winner={'value': 54.54, 'trustScore': 0.4194, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-32b.aaIdx: winner={'value': 76.4, 'trustScore': 0.4242, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
...
- qwen3-coder-30b.tau2: winner={'value': 19.59, 'trustScore': 0.4893, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- qwen3-coder-30b.gpqa: winner={'value': 65.8, 'trustScore': 0.4637, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- qwen3-coder-480b.tau2: winner={'value': 77.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-coder-480b.gpqa: winner={'value': 84.2, 'trustScore': 0.4637, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-coder-next.aaCoding: winner={'value': 22.89, 'trustScore': 0.495, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-02'} (severity=red, ΔNone)
- qwen3-coder-next.aaAgentic: winner={'value': 42.1, 'trustScore': 0.4898, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-coder-next.gpqa: winner={'value': 73.7, 'trustScore': 0.2875, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- qwen3-coder-next.lcb: winner={'value': 68.57, 'trustScore': 0.4029, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- qwen25-coder-7b.gpqa: winner={'value': 35.6, 'trustScore': 0.4023, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)
- deepseek-v3-2.sweV: winner={'value': 67.86, 'trustScore': 0.425, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- deepseek-v3-2.tb2: winner={'value': 46.4, 'trustScore': 0.4919, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v4-pro.sweV: winner={'value': 80.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- deepseek-v4-pro.lcb: winner={'value': 93.5, 'trustScore': 0.4739, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- deepseek-v4-flash.sweV: winner={'value': 79.0, 'trustScore': 0.4673, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
...
- deepseek-r1-14b.gpqa: winner={'value': 59.1, 'trustScore': 0.4833, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- deepseek-r1-14b.mmluPro: winner={'value': 93.9, 'trustScore': 0.2887, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
- gpt-5-5.sweV: winner={'value': 88.59, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- gpt-5-5.hle: winner={'value': 41.4, 'trustScore': 0.425, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gpt-5-6-sol.aaCoding: winner={'value': 80.0, 'trustScore': 0.495, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- grok-4-20.sweV: winner={'value': 76.7, 'trustScore': 0.4638, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- grok-4-20.gpqa: winner={'value': 88.5, 'trustScore': 0.4637, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- grok-4-20.tb2: winner={'value': 47.1, 'trustScore': 0.4843, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- grok-4-20.hle: winner={'value': 24.25, 'trustScore': 0.4206, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- grok-4-20.swePro: winner={'value': 51.8, 'trustScore': 0.4797, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- grok-4-20.arcAgi2: winner={'value': 53.3, 'trustScore': 0.495, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- grok-4-3.gpqa: winner={'value': 90.1, 'trustScore': 0.4637, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- grok-4-3.hle: winner={'value': 53.0, 'trustScore': 0.4919, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- nemotron-3-super.sweV: winner={'value': 60.47, 'trustScore': 0.4673, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- nemotron-3-super.gpqa: winner={'value': 79.23, 'trustScore': 0.4833, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- nemotron-3-super.aaIdx: winner={'value': 36.0, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- nemotron-3-super.tb2: winner={'value': 29.0, 'trustScore': 0.4238, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
...
- nemotron-3-super.mmluPro: winner={'value': 83.33, 'trustScore': 0.4182, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- nemotron-3-ultra.hle: winner={'value': 26.7, 'trustScore': 0.4671, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- nemotron-3-ultra.tau2: winner={'value': 83.3, 'trustScore': 0.495, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- nemotron-3-nano.gpqa: winner={'value': 73.04, 'trustScore': 0.35, 'tier': 'S', 'verifications': 5, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- nemotron-3-nano.aaIdx: winner={'value': 7.0, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- nemotron-3-nano.hle: winner={'value': 10.57, 'trustScore': 0.3454, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- nemotron-3-nano-omni.lcb: winner={'value': 68.25, 'trustScore': 0.4934, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- nemotron-3-nano-omni.aaIdx: winner={'value': 21.0, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- ling-2-6-1t.aaIdx: winner={'value': 34.0, 'trustScore': 0.3421, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- ring-2-6-1t.gpqa: winner={'value': 88.27, 'trustScore': 0.35, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- ring-2-6-1t.tau2: winner={'value': 95.32, 'trustScore': 0.3421, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- ring-2-6-1t.aaIdx: winner={'value': 30.57, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- ring-2-6-1t.aaCoding: winner={'value': 42.83, 'trustScore': 0.495, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- step-3-5-flash.sweV: winner={'value': 74.4, 'trustScore': 0.4673, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- step-3-5-flash.tb2: winner={'value': 51.0, 'trustScore': 0.4238, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- mimo-v2-5.aaCoding: winner={'value': 56.8, 'trustScore': 0.495, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- mimo-v2-5.aaIdx: winner={'value': 40.0, 'trustScore': 0.4242, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)
- mimo-v2-5.aaAgentic: winner={'value': 23.71, 'trustScore': 0.4898, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- mimo-v2-5.tau2: winner={'value': 94.2, 'trustScore': 0.4159, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- mimo-v2-5.tbHard: winner={'value': 41.67, 'trustScore': 0.4959, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- mimo-v2-5.tb2: winner={'value': 65.8, 'trustScore': 0.4919, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- mimo-v2-5.hle: winner={'value': 33.8, 'trustScore': 0.4206, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-22'} (severity=red, ΔNone)
- mimo-v2-5.gpqa: winner={'value': 86.6, 'trustScore': 0.4023, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-22'} (severity=yellow, ΔNone)
- mimo-v2-5-pro.gpqa: winner={'value': 66.7, 'trustScore': 0.3421, 'tier': 'S', 'verifications': 7, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- mimo-v2-5-pro.hle: winner={'value': 33.78, 'trustScore': 0.4948, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- mimo-v2-5-pro.tau2: winner={'value': 94.15, 'trustScore': 0.4893, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- mimo-v2-5-pro.tb2: winner={'value': 68.4, 'trustScore': 0.4919, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- qwen3-5-9b.hle: winner={'value': 13.3, 'trustScore': 0.4948, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- qwen3-5-9b.tbHard: winner={'value': 24.24, 'trustScore': 0.4215, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-5-9b.tb2: winner={'value': 9.21, 'trustScore': 0.5, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-7-max.aaIdx: winner={'value': 45.99, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- qwen3-7-max.tb2: winner={'value': 69.7, 'trustScore': 0.35, 'tier': 'S', 'verifications': 5, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- qwen3-7-max.hle: winner={'value': 41.4, 'trustScore': 0.4919, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- qwen3-7-plus.gpqa: winner={'value': 92.4, 'trustScore': 0.4023, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-7-plus.tb2: winner={'value': 70.3, 'trustScore': 0.4238, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-7-plus.hle: winner={'value': 34.7, 'trustScore': 0.4206, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
...
- llama-4-scout.gpqa: winner={'value': 58.7, 'trustScore': 0.4637, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- muse-spark.hle: winner={'value': 39.9, 'trustScore': 0.4948, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- muse-spark.swePro: winner={'value': 52.4, 'trustScore': 0.4797, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-24'} (severity=yellow, ΔNone)
- minimax-m2-5.nl2Repo: winner={'value': 39.8, 'trustScore': 0.4986, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-7.swePro: winner={'value': 56.2, 'trustScore': 0.4797, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- minimax-m2-7.sweV: winner={'value': 78.0, 'trustScore': 0.4638, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-6.gpqa: winner={'value': 90.5, 'trustScore': 0.4637, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- kimi-k2-6.hle: winner={'value': 54.0, 'trustScore': 0.4206, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- kimi-k2-6.aime26: winner={'value': 96.4, 'trustScore': 0.461, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- kimi-k2-6.tb2: winner={'value': 66.7, 'trustScore': 0.4843, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- kimi-k2-6.tau2: winner={'value': 70.6, 'trustScore': 0.4893, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-7-code.sweV: winner={'value': 60.4, 'trustScore': 0.2, 'tier': 'C', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- kimi-k2-6.aaCoding: winner={'value': 56.03, 'trustScore': 0.495, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- gpt-5-6-luna.aaCoding: winner={'value': 74.6, 'trustScore': 0.495, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- gemma-4-e2b.aaCoding: winner={'value': 9.0, 'trustScore': 0.4207, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-15'} (severity=yellow, ΔNone)
- gemma-4-e2b.aaAgentic: winner={'value': 6.92, 'trustScore': 0.4163, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- gemma-4-e4b.aaCoding: winner={'value': 13.7, 'trustScore': 0.4207, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
- gemma-4-e4b.aaAgentic: winner={'value': 6.92, 'trustScore': 0.4163, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gemma-4-12b.aaCoding: winner={'value': 30.96, 'trustScore': 0.495, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- gemma-4-12b.aaAgentic: winner={'value': 7.93, 'trustScore': 0.4898, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- llama-4-maverick.lcb: winner={'value': 43.4, 'trustScore': 0.425, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- llama-4-scout.lcb: winner={'value': 32.8, 'trustScore': 0.4029, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mistral-large-3.mmluPro: winner={'value': 73.11, 'trustScore': 0.425, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- ministral-3-3b.lcb: winner={'value': 24.66, 'trustScore': 0.4702, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
...
- deepseek-v3-2.lcb: winner={'value': 74.11, 'trustScore': 0.425, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-v3-2.mmluPro: winner={'value': 83.71, 'trustScore': 0.4711, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
...
- qwen25-coder-32b.mmluPro: winner={'value': 78.2, 'trustScore': 0.4182, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen25-coder-7b.lcb: winner={'value': 12.59, 'trustScore': 0.4702, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-24'} (severity=red, ΔNone)
- qwen25-coder-7b.mmluPro: winner={'value': 45.6, 'trustScore': 0.4004, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)

### Gaps (491 entries — agent:403 orchestrator:88 — see data/known-gaps.json or next refresh)
- `opus-4-7.cfElo` *(agent)*: agent surveyed; value unavailable
- `opus-4-7.nl2Repo` *(agent)*: agent surveyed; value unavailable
- `sonnet-4-6.cfElo` *(agent)*: agent surveyed; value unavailable
- `sonnet-4-6.nl2Repo` *(agent)*: agent surveyed; value unavailable
...
[fillRatio:0.69 cells:936/1360 contradictions:155 fetch:0.0min tools:None batches:None build:4d9d650]

### Updated
- 29 models: `gemma-4-31b`, `gemini-3-5-flash`, `llama-4-scout`, `qwen25-coder-32b`, `qwen3-6-35b-moe`, `minimax-m3`, `gpt-5-6-sol`, `grok-4-3`, `step-3-5-flash`, `mimo-v2-5-pro`, `muse-spark`, `kimi-k2-6`, `gemma-4-e4b`, `mimo-v2-5`, `qwen3-coder-next`, `claude-sonnet-5`, `llama-4-maverick`, `ministral-3-14b`, `qwen3-235b`, `gpt-5-4`, `minimax-m2-7`, `gemma-3-27b`, `step-3-7-flash`, `gpt-5-6-luna`, `qwen3-32b`, `qwen25-coder-7b`, `qwen3-5-9b`, `minimax-m2-1`, `opus-4-7`

### Resolved (auto via trustScore)
- gpt-5-5.aaCoding: winner={'value': 74.89, 'trustScore': 0.4949, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- gpt-5-4-mini.sweV: winner={'value': 68.1, 'trustScore': 0.4673, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- gpt-5-6-sol.aaCoding: winner={'value': 80.0, 'trustScore': 0.4949, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- gpt-5-6-sol.mrcr: winner={'value': 91.5, 'trustScore': 0.4325, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- gpt-5-6-sol.browseComp: winner={'value': 92.2, 'trustScore': 0.4325, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- gpt-5-6-luna.aaCoding: winner={'value': 75.0, 'trustScore': 0.4949, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- opus-4-7.sweV: winner={'value': 87.6, 'trustScore': 0.425, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- opus-4-7.swePro: winner={'value': 64.3, 'trustScore': 0.4325, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- opus-4-7.gpqa: winner={'value': 94.2, 'trustScore': 0.4752, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- opus-4-7.tb2: winner={'value': 69.4, 'trustScore': 0.4325, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- sonnet-4-6.sweV: winner={'value': 79.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- sonnet-4-6.gpqa: winner={'value': 74.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- sonnet-4-6.arcAgi2: winner={'value': 58.3, 'trustScore': 0.425, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- claude-haiku-4-5.sweV: winner={'value': 73.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- claude-fable-5.tb2: winner={'value': 88.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- claude-fable-5.hle: winner={'value': 64.5, 'trustScore': 0.462, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-fable-5.aaIdx: winner={'value': 60.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- claude-fable-5.gpqa: winner={'value': 92.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- claude-mythos-5.sweV: winner={'value': 93.9, 'trustScore': 0.4673, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- gemini-3-1-pro.gpqa: winner={'value': 94.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- gemini-3-1-pro.hle: winner={'value': 44.4, 'trustScore': 0.425, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- gemini-3-1-pro.tb2: winner={'value': 68.5, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- gemini-3-1-pro.swePro: winner={'value': 54.2, 'trustScore': 0.425, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- gemini-3-1-pro.tbHard: winner={'value': 44.3, 'trustScore': 0.4965, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- gemini-3-1-pro.aaIdx: winner={'value': 57.02, 'trustScore': 0.4242, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- gemini-3-1-flash.sweV: winner={'value': 78.0, 'trustScore': 0.425, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemini-3-1-flash.gpqa: winner={'value': 90.18, 'trustScore': 0.425, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- gemini-3-1-flash.hle: winner={'value': 34.7, 'trustScore': 0.425, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- gemma-3-27b.gpqa: winner={'value': 42.4, 'trustScore': 0.4837, 'tier': 'I', 'verifications': 24, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- gemma-3-27b.lcb: winner={'value': 29.1, 'trustScore': 0.491, 'tier': 'I', 'verifications': 21, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- gemma-3-27b.tau2: winner={'value': 6.6, 'trustScore': 0.491, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- gemma-3-27b.cfElo: winner={'value': 110.0, 'trustScore': 0.2, 'tier': 'C', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-3-27b.aaAgentic: winner={'value': 0.27, 'trustScore': 0.4896, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- gemma-4-31b.gpqa: winner={'value': 84.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 27, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- gemma-4-26b-moe.gpqa: winner={'value': 82.3, 'trustScore': 0.4876, 'tier': 'I', 'verifications': 23, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- gemma-4-26b-moe.cfElo: winner={'value': 1718.0, 'trustScore': 0.398, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- mistral-large-3.gpqa: winner={'value': 67.98, 'trustScore': 0.4752, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- codestral.sweV: winner={'value': 76.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- codestral.swePro: winner={'value': 2.0, 'trustScore': 0.425, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-05-13'} (severity=red, ΔNone)
- codestral.lcb: winner={'value': 37.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- mistral-medium-3-5.sweV: winner={'value': 77.6, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- mistral-small-4.aaIdx: winner={'value': 19.56, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- qwen3-6-27b.sweV: winner={'value': 77.2, 'trustScore': 0.425, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- qwen3-6-27b.gpqa: winner={'value': 87.8, 'trustScore': 0.356, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-6-27b.lcb: winner={'value': 83.9, 'trustScore': 0.4052, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- qwen3-6-max.gpqa: winner={'value': 86.0, 'trustScore': 0.4039, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- qwen3-6-max.lcb: winner={'value': 77.8, 'trustScore': 0.4052, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-6-max.aaIdx: winner={'value': 40.0, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- qwen3-6-max.tb2: winner={'value': 65.4, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)
- qwen3-6-max.hle: winner={'value': 51.0, 'trustScore': 0.4208, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-235b.sweV: winner={'value': 79.0, 'trustScore': 0.4673, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-235b.gpqa: winner={'value': 81.1, 'trustScore': 0.4111, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- qwen3-235b.lcb: winner={'value': 74.48, 'trustScore': 0.4174, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-235b.tb2: winner={'value': 65.0, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-235b.hle: winner={'value': 42.0, 'trustScore': 0.4208, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-235b.aime26: winner={'value': 92.3, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- qwen3-32b.sweV: winner={'value': 72.0, 'trustScore': 0.4673, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-32b.lcb: winner={'value': 54.6, 'trustScore': 0.4192, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-32b.tb2: winner={'value': 56.3, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-32b.mmluPro: winner={'value': 79.1, 'trustScore': 0.4701, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-6-35b-moe.gpqa: winner={'value': 86.0, 'trustScore': 0.2975, 'tier': 'S', 'verifications': 9, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- qwen3-6-35b-moe.lcb: winner={'value': 80.4, 'trustScore': 0.4052, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-15'} (severity=yellow, ΔNone)
- qwen3-6-35b-moe.tb2: winner={'value': 51.5, 'trustScore': 0.4837, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-35b-moe.aaIdx: winner={'value': 31.65, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- qwen3-6-plus.sweV: winner={'value': 78.8, 'trustScore': 0.425, 'tier': 'I', 'verifications': 20, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- qwen3-6-plus.mmluPro: winner={'value': 88.5, 'trustScore': 0.4837, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- qwen3-6-plus.aime26: winner={'value': 75.3, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-6-plus.aaAgentic: winner={'value': 27.55, 'trustScore': 0.4896, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- qwen3-coder-30b.sweV: winner={'value': 51.9, 'trustScore': 0.491, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- qwen3-coder-30b.tb2: winner={'value': 36.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-coder-30b.aaIdx: winner={'value': 20.0, 'trustScore': 0.4242, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-05-11'} (severity=red, ΔNone)
- qwen3-coder-480b.tb2: winner={'value': 23.9, 'trustScore': 0.2975, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-coder-480b.aaIdx: winner={'value': 25.0, 'trustScore': 0.4242, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-05-11'} (severity=red, ΔNone)
- qwen3-coder-next.sweV: winner={'value': 70.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- qwen3-coder-next.aaCoding: winner={'value': 22.89, 'trustScore': 0.4949, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- qwen25-coder-32b.lcb: winner={'value': 48.69, 'trustScore': 0.4052, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- qwen25-coder-7b.lcb: winner={'value': 37.6, 'trustScore': 0.2975, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
- deepseek-v3-2.sweV: winner={'value': 67.8, 'trustScore': 0.425, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- deepseek-v3-2.gpqa: winner={'value': 82.4, 'trustScore': 0.4111, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- deepseek-v3-2.lcb: winner={'value': 74.1, 'trustScore': 0.425, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- deepseek-v3-2.tb2: winner={'value': 46.4, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- deepseek-v3-2.cfElo: winner={'value': 2386.0, 'trustScore': 0.2922, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- deepseek-v3-2.mmluPro: winner={'value': 85.0, 'trustScore': 0.425, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- deepseek-v3-2.hle: winner={'value': 24.86, 'trustScore': 0.4208, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-v4-pro.aaIdx: winner={'value': 44.0, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- deepseek-v4-pro.sweV: winner={'value': 80.6, 'trustScore': 0.425, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- deepseek-v4-pro.lcb: winner={'value': 93.5, 'trustScore': 0.4768, 'tier': 'I', 'verifications': 22, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- deepseek-v4-pro.swePro: winner={'value': 55.4, 'trustScore': 0.425, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- deepseek-v4-flash.sweV: winner={'value': 79.0, 'trustScore': 0.425, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- deepseek-v4-flash.lcb: winner={'value': 91.44, 'trustScore': 0.425, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- deepseek-r1-14b.gpqa: winner={'value': 59.1, 'trustScore': 0.4813, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- glm-5.gpqa: winner={'value': 85.35, 'trustScore': 0.4813, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- glm-4-7.gpqa: winner={'value': 85.7, 'trustScore': 0.4752, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- glm-4-7.sweV: winner={'value': 73.75, 'trustScore': 0.3972, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- glm-4-7.mmluPro: winner={'value': 84.3, 'trustScore': 0.4633, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- gemma-4-e4b.gpqa: winner={'value': 58.6, 'trustScore': 0.4682, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- gemma-4-e4b.mmluPro: winner={'value': 69.4, 'trustScore': 0.4682, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- gemini-3-5-flash.sweV: winner={'value': 81.0, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- gemini-3-5-flash.aaIdx: winner={'value': 50.2, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- claude-sonnet-5.sweV: winner={'value': 85.2, 'trustScore': 0.4673, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- claude-mythos-preview.sweV: winner={'value': 93.9, 'trustScore': 0.4673, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- claude-mythos-preview.gpqa: winner={'value': 94.5, 'trustScore': 0.2, 'tier': 'C', 'verifications': 2, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- nemotron-3-super.sweV: winner={'value': 60.47, 'trustScore': 0.4673, 'tier': 'I', 'verifications': 21, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- nemotron-3-super.gpqa: winner={'value': 79.23, 'trustScore': 0.4813, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- nemotron-3-super.hle: winner={'value': 18.26, 'trustScore': 0.4594, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- nemotron-3-super.tau2: winner={'value': 67.8, 'trustScore': 0.4113, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- nemotron-3-super.tb2: winner={'value': 29.0, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- nemotron-3-super.tbHard: winner={'value': 28.96, 'trustScore': 0.4965, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-02'} (severity=yellow, ΔNone)
- nemotron-3-super.lcb: winner={'value': 81.19, 'trustScore': 0.4768, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- nemotron-3-super.aaIdx: winner={'value': 36.0, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- nemotron-3-ultra.hle: winner={'value': 26.7, 'trustScore': 0.425, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- nemotron-3-ultra.tb2: winner={'value': 56.4, 'trustScore': 0.425, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
...
- nemotron-3-nano.lcb: winner={'value': 68.25, 'trustScore': 0.491, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- nemotron-3-nano.aaIdx: winner={'value': 7.0, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- nemotron-3-nano-omni.aaIdx: winner={'value': 21.0, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- step-3-5-flash.sweV: winner={'value': 74.4, 'trustScore': 0.4758, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- step-3-5-flash.tb2: winner={'value': 51.0, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- step-3-5-flash.gpqa: winner={'value': 83.5, 'trustScore': 0.4752, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- step-3-7-flash.tb2: winner={'value': 59.55, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- step-3-7-flash.aaIdx: winner={'value': 30.0, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- step-3-7-flash.tau2: winner={'value': 88.2, 'trustScore': 0.4839, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- qwen3-7-plus.aaAgentic: winner={'value': 20.81, 'trustScore': 0.4896, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- mimo-v2-5-pro.gpqa: winner={'value': 66.7, 'trustScore': 0.3413, 'tier': 'S', 'verifications': 6, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- mimo-v2-5-pro.lcb: winner={'value': 76.2, 'trustScore': 0.425, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- mimo-v2-5-pro.hle: winner={'value': 33.87, 'trustScore': 0.4208, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-20.gpqa: winner={'value': 88.0, 'trustScore': 0.4188, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- grok-4-20.hle: winner={'value': 24.25, 'trustScore': 0.4208, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- grok-4-20.tbHard: winner={'value': 16.7, 'trustScore': 0.4965, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- grok-4-20.tau2: winner={'value': 93.0, 'trustScore': 0.4839, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- grok-4-20.arcAgi2: winner={'value': 15.9, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- grok-4-3.gpqa: winner={'value': 90.08, 'trustScore': 0.4752, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- llama-4-maverick.gpqa: winner={'value': 69.8, 'trustScore': 0.4111, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- llama-4-maverick.lcb: winner={'value': 43.4, 'trustScore': 0.4742, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- llama-4-scout.gpqa: winner={'value': 57.2, 'trustScore': 0.4111, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- llama-4-scout.lcb: winner={'value': 32.8, 'trustScore': 0.4052, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- muse-spark.aaIdx: winner={'value': 43.0, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- muse-spark.hle: winner={'value': 39.9, 'trustScore': 0.4951, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-6.aaCoding: winner={'value': 56.03, 'trustScore': 0.4949, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- mimo-v2-5.aaIdx: winner={'value': 40.0, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)
- mimo-v2-5.aaCoding: winner={'value': 42.13, 'trustScore': 0.4207, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mimo-v2-5.aaAgentic: winner={'value': 65.53, 'trustScore': 0.4162, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- qwen3-5-9b.aaCoding: winner={'value': 25.3, 'trustScore': 0.4949, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- mistral-small-4.aaAgentic: winner={'value': 4.7, 'trustScore': 0.4896, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- step-3-7-flash.aaCoding: winner={'value': 39.57, 'trustScore': 0.4949, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- opus-4-7.aaIdx: winner={'value': 57.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)
- muse-spark.aaCoding: winner={'value': 47.5, 'trustScore': 0.4949, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-coder-next.aaAgentic: winner={'value': 42.1, 'trustScore': 0.4896, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-26b-moe.hle: winner={'value': 22.0, 'trustScore': 0.4208, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-31b.hle: winner={'value': 22.95, 'trustScore': 0.4208, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gemma-4-e2b.gpqa: winner={'value': 43.4, 'trustScore': 0.4039, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-11'} (severity=red, ΔNone)
- glm-5-2.hle: winner={'value': 40.0, 'trustScore': 0.4951, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- mimo-v2-5.tbHard: winner={'value': 26.5, 'trustScore': 0.422, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-05-09'} (severity=red, ΔNone)
- mistral-small-4.gpqa: winner={'value': 71.2, 'trustScore': 0.4039, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- deepseek-r1-14b.aaIdx: winner={'value': 16.0, 'trustScore': 0.4991, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)

### Gaps (424 entries — agent:380 orchestrator:44 — see data/known-gaps.json or next refresh)
- `gpt-5-4.cfElo` *(agent)*: agent surveyed; value unavailable
- `gpt-5-5.cfElo` *(agent)*: agent surveyed; value unavailable
- `gpt-5-5.nl2Repo` *(agent)*: agent surveyed; value unavailable
- `gpt-5-4-mini.tbHard` *(agent)*: agent surveyed; value unavailable
- `gpt-5-4-mini.cfElo` *(agent)*: agent surveyed; value unavailable
- `gpt-5-4-mini.nl2Repo` *(agent)*: agent surveyed; value unavailable
- `gemini-3-1-flash.cfElo` *(orchestrator)*: not reached in agent survey cycle; Codeforces ELO data unavailable
- `gemma-3-27b.arcAgi2` *(orchestrator)*: not reached in agent survey cycle; ARC-AGI-2 data unavailable
- ... and 416 more

### Lineup
- Reconfirmed 3 deprecations (already applied prior cycle, evidence refreshed): `mimo-v2-pro`, `mimo-v2-flash`, `mimo-v2-omni` (vendor docs: deprecated 2026-06-30).
- 3 new-model candidates gated as superseded-by-newer-version and NOT admitted: `grok-4-5`, `kimi-k2-5`, `minimax-m2-5-highspeed`.
- ⚠ **Flagged for human review:** `grok-4-5` may be a false-negative gate. xAI's live `docs.x.ai/docs/models` lists it as the current active/recommended-default flagship (released 2026-07-08, after every tracked `grok-4-*` id), independently corroborated by vals.ai (86.60% SWE-bench Verified, 64.7% SWE-bench Pro) and AA (Intelligence Index rank #4) — see `lineupChanges.hints` in `.aicodermap-agent-out-synth.json`. The auto-gate compares dotted version tuples only (`(4,20) > (4,5)`) and has no release-date awareness, so it can't distinguish "higher minor version" from "actually newer" when a vendor's numbering isn't chronologically monotonic. Left un-admitted this cycle per the project's no-hardcoded-model-patch policy; next cycle's fresh evidence (or a human correction to `scripts/add-new-lineup-stubs.py::is_superseded`) should resolve it.

### Post-merge corrections
- AA-authoritative pass: 10 composite-index overrides applied (aaIdx/aaCoding/aaAgentic vs `_aa-rows.json`), 7 models touched.
- `reconcile-stored-winners.py`: 22 stale single-source cells replaced by a stronger multi-source consensus already present in `sources.json` (e.g. `deepseek-v4-pro.lcb` 85.9→93.5 across 22 sources, `claude-haiku-4-5.tau2` 54.7→83.0 across 6 sources).
- 3 anomaly-verify verdicts, all **confirmed** (no misfile): `gemma-3-27b.cfElo=110.0`, `gemma-4-e2b.cfElo=633.0`, `deepseek-r1-14b.cfElo=1481.0` — small/weak-coder models can legitimately sit outside the [1000,3500] soft Codeforces-Elo band; huggingface.co's `publishes[]` whitelist entry was simply incomplete (missing cfElo alongside webDevElo), not a real source-mismatch.

### Pipeline fixes (this cycle)
- `scripts/lib/whitelist.py::filter_for_batch`: vendor-name fuzzy matcher failed on punctuated display names (`"Z.ai (Zhipu AI)"` never matched vendor key `zai_glm`), silently emptying that vendor's per-batch whitelist bundle every cycle. Fixed to strip `.`/`()` before tokenizing.
- `scripts/local-synth.py`: synth unconditionally hardcoded `lineupChanges.{deprecated,renamed,removed}` to `[]`, dropping Step 0's vendor-confirmed deprecations before they could reach `merge.py`. Now aggregates them from the gather artifacts (deduped by id), same as the existing `hints` channel.
- Both fixes verified against the full `pytest` suite (139/139 passing) before this cycle's merge.

### Supplementary deep-research pass (same-day, targeted gap-fill)
- User request: research the 30 active models with the lowest core-bench coverage or missing a ranking-required bench (`swePro`/`lcb`), since several couldn't be ranked at all (`gemini-omni-flash`, `grok-build-0-1`, `codestral`, `claude-mythos-preview`, `gpt-5-6-terra`, `gpt-5-6-luna`, `ministral-3-{14b,8b,3b}`, `qwen25-coder-14b`) or carried critical gaps while still ranked (`claude-sonnet-5` missing `lcb`, `deepseek-r1-14b`/`mistral-small-4`/`glm-5-turbo` missing `swePro`+`tb2`, and 17 more).
- Dispatched 8 vendor-grouped `aicodermap-research-agent` gather batches (101 raw observations, 101 rawGaps) with an explicitly larger budget and instructions to go beyond the standard leaderboard sweep (vendor technical reports, HF model cards, GitHub READMEs, arXiv papers, press coverage).
- Net result after the full `local-synth.py → gen_unified_artifact.py → gap_gen.py → merge.py → reconcile-stored-winners.py --apply` chain: **24 core-bench cells filled across 8 models** — `gpt-5-6-terra` +3 (gpqa/mrcr/arcAgi2), `gpt-5-6-luna` +3 (gpqa/mrcr/arcAgi2), `ministral-3-14b`/`ministral-3-8b`/`ministral-3-3b` +4 each (tau2/hle/tbHard/mmluPro), `gemma-4-e2b`/`gemma-4-e4b`/`gemma-4-26b-moe`/`gemma-4-12b` +1 each (tbHard). Zero regressions (0 lost cells).
- **Honest finding, not a data gap:** the other 22 target models (incl. `gemini-omni-flash`, `grok-build-0-1`, `codestral`, `claude-mythos-preview`, `claude-sonnet-5.lcb`) gained zero promotable cells despite genuine new evidence being found (10 `sources.json` cells gained an additional corroborating source) — every new lead was either single-source or below the `MIN_SOURCES_PER_FILLED_CELL=2` bar (`_schema.contracts`). This is the evidence-quality gate working as designed: these models are either too new/restricted-preview to have independent leaderboard coverage yet, or the second corroborating source genuinely doesn't exist yet. `gemini-omni-flash` was re-surveyed via 3+ new source types (Google dev blog, Vertex AI docs, press, arXiv) beyond the 2 it had already exhausted on 2026-07-11 — still zero results; likely has no public benchmark disclosure yet.
- **Follow-up (user question) — `kimi-k2-7-code`:** confirmed via Moonshot's own official HuggingFace model card (moonshotai/Kimi-K2.7-Code) that `swePro` is a **genuine structural gap, not a research miss** — the model's official benchmark table (6 rows) covers only Moonshot's proprietary suites; no SWE-bench Verified/Pro, Terminal-Bench, LiveCodeBench, GPQA, AIME, or MMLU-Pro was published at launch. This is why the model sits in the "Limited Coverage" band (missing the `swe-focused` preset's required `swePro`). ⚠ **Misattribution warning for future cycles:** a "K2.7-Code SWE-bench Pro: 58.6" figure circulating on aggregator sites (vm0.ai, awesomeagents.ai, vals.ai) traces to `kimi-k2-6`'s own score (correctly recorded at `kimi-k2-6.bench.swePro=58.6`) being mis-copied onto K2.7-Code by secondary sources — do NOT file it into `kimi-k2-7-code.swePro`. No separate general-purpose "Kimi K2.7" product exists (Moonshot's full model catalog confirms K2.7-Code is the only K2.7 release) — the lineup is complete.

### Follow-up pipeline improvements (Fable-5 R1/R2/R4/R5, applied this session)
- **R1 — per-model rescue batch:** `SKILL.md` Stage A gained step "3.6b RESCUE_BATCH" — unions zero-observation models across ALL batches this cycle (`lib.gather_validator.zero_obs_models`, new), not just whole-batch 0-fills (the existing FAZ 2.4 net), and dispatches ONE rescue agent with the FULL unfiltered whitelist for all of them together.
- **R2 — chronic-gap ledger:** every gap now carries its cycle stamp into a NEW parallel `gapHistoryAgent` list on top of the existing `gapHistory` (`_stamp_gap_history` source param, `lib.matrix.gap_source_by_cell`) — a cell with ≥3 consecutive AGENT-sourced (not orchestrator-placeholder) failed attempts is flagged `chronic` in `priority_cells` and surfaced in a new CHANGELOG "### Chronically unfilled" section, distinct from the raw Gaps dump. Starts accumulating from this cycle (0 chronic cells yet — needs 3 cycles of history).
- **R3 — rank-criticality boost:** `lib.matrix.priority_cells` gained a `rankCritical` tier — a cell that is a preset's `requiredBench` (`lib.whitelist.required_bench_keys`, new) AND the model's last missing required cell now outranks raw-starvation ordering.
- **R4 — loud vendor-match guard + mixed-batch labels:** `filter_for_batch` prints a loud `WARN` when a batch's provider matches zero whitelist vendor keys (the exact silent-failure class that hid `zai_glm`'s bundle); `compute_dispatch_plan` now labels a batch spanning multiple vendor families `batchNN-mixed-<fam1>-<fam2>` instead of a misleading single-vendor name.
- **R5 — new-model coverage floor:** new `scripts/check-new-model-coverage.py` (wired into `refresh-finalize.py`) warns loudly + appends a CHANGELOG note when a model admitted THIS cycle is still below the `ABSOLUTE_COVERAGE_FLOOR` after Stage A/B — distinguishes "freshly-launched, expected-thin-data" from a silent pipeline miss.
- All five verified via `pytest` (158/158 passing) + `audit-data-coherence.py` + a real `refresh-finalize.py` end-to-end run.

### Pipeline fixes (supplementary pass, root-cause)
- **`scripts/merge.py` stale-artifact guard (new, HARD BLOCK):** running `local-synth.py` again and then invoking `merge.py` directly — skipping `gen_unified_artifact.py`/`gap_gen.py` — made `merge.py` silently read a STALE `.aicodermap-agent-out.json` and drop every fresh finding with zero error signal. This is exactly what happened on the first two integration attempts of this session: 0 promoted fills, plus a stale-cluster-winner regression only `reconcile-stored-winners.py --apply` caught. `merge.py` now compares `.aicodermap-agent-out-synth.json`'s mtime against `.aicodermap-agent-out.json`'s and aborts loudly (pointing at `scripts/refresh-finalize.py`) when the artifact predates the synth output; bypass via `--allow-stale-artifact`.
- **`scripts/merge.py::_write_changelog` same-day section loss (fixed):** the same-day-consolidation rewrite (2026-06-06) regenerates the WHOLE `## [today]` block from the current process's `out` every call — correct when one continuously-orchestrated cycle calls merge.py more than once, but a later same-day supplementary run (like this one, `out` built from only 8 fresh batches) produced a thinner `out` and silently deleted the original cycle's `### Lineup`/`### Post-merge corrections`/`### Pipeline fixes` sections not present in its own regeneration — hit 3 times this session before being traced. Fixed: `_write_changelog` now diffs the outgoing and incoming same-day blocks by `###` subsection and re-appends any subsection the fresh blob doesn't reproduce, so a thinner regeneration only ADDS to the day's record instead of replacing it.
- `scripts/refresh-finalize.py` already existed and chains `gen_unified_artifact → validate-artifact-keys → gap_gen → merge → add-new-lineup-stubs → reconcile-stored-winners --apply` correctly — it just wasn't used for this ad-hoc supplementary pass. Recommendation for future sessions: always run `python scripts/refresh-finalize.py` after `local-synth.py`, never `merge.py` standalone.
...
### Added
- `claude-sonnet-5` (NEW) — Anthropic Claude Sonnet 5, released 2026-06-30 (official: anthropic.com/news/claude-sonnet-5). Admitted pre-gather (lineup-first ordering) and benches filled the same run.

### Deprecated
- `mimo-v2-flash` — Xiaomi marked it deprecated per official docs (2026-06-30), consistent with the already-deprecated `mimo-v2-pro` / `mimo-v2-omni`. Entry retained in full, rendered faded, dropped from the research universe.

### Updated
- 40 models: `deepseek-v4-pro`, `minimax-m2-1`, `claude-fable-5`, `mimo-v2-5-pro`, `gemma-4-e2b`, `qwen3-6-27b`, `minimax-m2-5`, `mimo-v2-5`, `gemini-3-5-flash`, `nemotron-3-nano`, `nemotron-3-super`, `qwen3-32b`, `grok-4-3`, `gpt-5-4-nano`, `gemini-3-1-pro`, `llama-4-scout`, `glm-4-5-air`, `gemma-4-26b-moe`, `gemma-4-31b`, `qwen25-coder-7b`, `qwen3-235b`, `kimi-k2-7-code`, `claude-sonnet-5`, `step-3-5-flash`, `glm-5-turbo`, `deepseek-v4-flash`, `opus-4-7`, `gemma-4-e4b`, `gemini-3-1-flash`, `qwen25-coder-32b`, `qwen3-5-9b`, `gemma-3-27b`, `mistral-medium-3-5`, `glm-5`, `qwen3-6-35b-moe`, `minimax-m2-7`, `claude-haiku-4-5`, `muse-spark`, `llama-4-maverick`, `step-3-7-flash`

### Resolved (auto via trustScore)
- opus-4-7.sweV: winner={'value': 87.6, 'trustScore': 0.4696, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- opus-4-7.swePro: winner={'value': 64.3, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- opus-4-7.gpqa: winner={'value': 94.2, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-07-01'} (severity=yellow, ΔNone)
- opus-4-7.hle: winner={'value': 46.9, 'trustScore': 0.4361, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- opus-4-7.aaIdx: winner={'value': 57.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)
- sonnet-4-6.sweV: winner={'value': 79.6, 'trustScore': 0.4682, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- sonnet-4-6.arcAgi2: winner={'value': 58.3, 'trustScore': 0.4361, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- sonnet-4-6.tau2: winner={'value': 91.7, 'trustScore': 0.4723, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- sonnet-4-6.gpqa: winner={'value': 74.1, 'trustScore': 0.4682, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-haiku-4-5.sweV: winner={'value': 73.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- claude-haiku-4-5.gpqa: winner={'value': 67.2, 'trustScore': 0.425, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-haiku-4-5.aaIdx: winner={'value': 31.0, 'trustScore': 0.425, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-haiku-4-5.tau2: winner={'value': 83.0, 'trustScore': 0.4723, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- claude-opus-4-8.hle: winner={'value': 49.8, 'trustScore': 0.4968, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- claude-fable-5.hle: winner={'value': 64.5, 'trustScore': 0.4719, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-fable-5.aaIdx: winner={'value': 60.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-01'} (severity=yellow, ΔNone)
- claude-fable-5.tb2: winner={'value': 88.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- claude-fable-5.tau2: winner={'value': 98.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-mythos-5.swePro: winner={'value': 80.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-01'} (severity=yellow, ΔNone)
- claude-mythos-5.sweV: winner={'value': 93.9, 'trustScore': 0.4753, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-01'} (severity=yellow, ΔNone)
- claude-mythos-5.tau2: winner={'value': 98.5, 'trustScore': 0.4893, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v3-2.gpqa: winner={'value': 82.4, 'trustScore': 0.4127, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- deepseek-v3-2.hle: winner={'value': 24.86, 'trustScore': 0.4968, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- deepseek-v3-2.mmluPro: winner={'value': 85.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- deepseek-v3-2.lcb: winner={'value': 74.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- deepseek-v3-2.cfElo: winner={'value': 2386.0, 'trustScore': 0.345, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- deepseek-v3-2.tb2: winner={'value': 46.4, 'trustScore': 0.4919, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- deepseek-v3-2.sweV: winner={'value': 67.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v3-2.sweMulti: winner={'value': 57.86, 'trustScore': 0.345, 'tier': 'S', 'verifications': 4, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- deepseek-v3-2.tau2: winner={'value': 71.3, 'trustScore': 0.425, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-22'} (severity=red, ΔNone)
- deepseek-v4-pro.sweV: winner={'value': 80.6, 'trustScore': 0.4753, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- deepseek-v4-pro.lcb: winner={'value': 93.5, 'trustScore': 0.4824, 'tier': 'I', 'verifications': 21, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- deepseek-v4-pro.gpqa: winner={'value': 90.1, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- deepseek-v4-pro.swePro: winner={'value': 55.4, 'trustScore': 0.425, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- deepseek-v4-flash.sweV: winner={'value': 79.0, 'trustScore': 0.425, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- deepseek-v4-flash.lcb: winner={'value': 91.44, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
...
- deepseek-r1-14b.sweV: winner={'value': 46.0, 'trustScore': 0.4696, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)
- deepseek-r1-14b.gpqa: winner={'value': 59.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- deepseek-r1-14b.aaIdx: winner={'value': 16.0, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-r1-14b.aime26: winner={'value': 70.02, 'trustScore': 0.4689, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- gemini-3-1-flash.sweV: winner={'value': 78.0, 'trustScore': 0.4753, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemini-3-1-flash.gpqa: winner={'value': 90.18, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- gemini-3-1-flash.hle: winner={'value': 34.52, 'trustScore': 0.4855, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemini-3-1-flash.mmluPro: winner={'value': 89.0, 'trustScore': 0.4703, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- gemini-3-1-flash.tau2: winner={'value': 71.5, 'trustScore': 0.4893, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- gemini-3-1-flash.aime26: winner={'value': 97.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- gemini-3-1-pro.gpqa: winner={'value': 94.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- gemini-3-1-pro.lcb: winner={'value': 91.7, 'trustScore': 0.4826, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- gemini-3-1-pro.aaIdx: winner={'value': 57.02, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
- gemini-3-1-pro.hle: winner={'value': 44.4, 'trustScore': 0.4968, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- gemini-3-1-pro.swePro: winner={'value': 54.2, 'trustScore': 0.425, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gemini-3-1-pro.mmluPro: winner={'value': 90.99, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)
- gemini-3-1-pro.tau2: winner={'value': 76.5, 'trustScore': 0.4855, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-3-27b.gpqa: winner={'value': 42.4, 'trustScore': 0.4874, 'tier': 'I', 'verifications': 24, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-3-27b.aaIdx: winner={'value': 4.78, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-26b-moe.sweV: winner={'value': 64.0, 'trustScore': 0.4696, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-26b-moe.gpqa: winner={'value': 82.3, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 23, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-26b-moe.aaIdx: winner={'value': 31.0, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- gemma-4-26b-moe.cfElo: winner={'value': 1718.0, 'trustScore': 0.4783, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- gemma-4-31b.gpqa: winner={'value': 84.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 27, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- gemma-4-31b.hle: winner={'value': 23.0, 'trustScore': 0.4968, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- gemma-4-31b.aaIdx: winner={'value': 29.35, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- gemma-4-e2b.aime26: winner={'value': 37.5, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- gemma-4-e4b.mmluPro: winner={'value': 69.4, 'trustScore': 0.4783, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- gemini-3-5-flash.aaIdx: winner={'value': 50.2, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-01'} (severity=yellow, ΔNone)
- mistral-large-3.sweV: winner={'value': 55.34, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- mistral-large-3.gpqa: winner={'value': 67.98, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- mistral-large-3.tb2: winner={'value': 42.8, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- mistral-large-3.tau2: winner={'value': 70.2, 'trustScore': 0.4893, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- codestral.sweV: winner={'value': 76.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mistral-medium-3-5.sweV: winner={'value': 77.6, 'trustScore': 0.4783, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- mistral-medium-3-5.gpqa: winner={'value': 71.22, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- mistral-medium-3-5.hle: winner={'value': 9.5, 'trustScore': 0.4968, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- mistral-medium-3-5.tau2: winner={'value': 91.4, 'trustScore': 0.4127, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-16'} (severity=yellow, ΔNone)
- mistral-medium-3-5.tbHard: winner={'value': 20.45, 'trustScore': 0.4977, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- mistral-small-4.gpqa: winner={'value': 71.2, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- kimi-k2-6.sweV: winner={'value': 80.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- kimi-k2-6.gpqa: winner={'value': 90.54, 'trustScore': 0.4855, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-6.lcb: winner={'value': 89.6, 'trustScore': 0.4127, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-6.tb2: winner={'value': 66.7, 'trustScore': 0.4181, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-6.hle: winner={'value': 54.0, 'trustScore': 0.4223, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-6.tau2: winner={'value': 70.6, 'trustScore': 0.4893, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-7-code.hle: winner={'value': 38.2, 'trustScore': 0.2, 'tier': 'C', 'verifications': 2, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- kimi-k2-7-code.gpqa: winner={'value': 89.6, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- nemotron-3-super.sweV: winner={'value': 60.47, 'trustScore': 0.4929, 'tier': 'I', 'verifications': 21, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- nemotron-3-super.tbHard: winner={'value': 28.96, 'trustScore': 0.4977, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- nemotron-3-super.aaIdx: winner={'value': 36.0, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- nemotron-3-nano-omni.gpqa: winner={'value': 72.47, 'trustScore': 0.4874, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- nemotron-3-nano-omni.tau2: winner={'value': 49.04, 'trustScore': 0.4657, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- nemotron-3-nano.lcb: winner={'value': 68.25, 'trustScore': 0.3313, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- gpt-5-4.swePro: winner={'value': 58.31, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- gpt-5-4.hle: winner={'value': 39.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gpt-5-5.sweV: winner={'value': 88.59, 'trustScore': 0.4696, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- gpt-5-5.mrcr: winner={'value': 74.0, 'trustScore': 0.4181, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- gpt-5-5.aaIdx: winner={'value': 54.84, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- gpt-5-4-mini.hle: winner={'value': 41.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- gpt-5-4-nano.hle: winner={'value': 26.5, 'trustScore': 0.4968, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-6-27b.sweV: winner={'value': 77.2, 'trustScore': 0.4753, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- qwen3-6-27b.gpqa: winner={'value': 87.8, 'trustScore': 0.3646, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-6-27b.lcb: winner={'value': 83.9, 'trustScore': 0.41, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- qwen3-6-max.gpqa: winner={'value': 86.0, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- qwen3-6-max.lcb: winner={'value': 77.8, 'trustScore': 0.4826, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-6-max.tb2: winner={'value': 65.4, 'trustScore': 0.4238, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)
- qwen3-6-max.hle: winner={'value': 51.0, 'trustScore': 0.4968, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-max.aaIdx: winner={'value': 40.0, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- qwen3-235b.sweV: winner={'value': 79.0, 'trustScore': 0.4753, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-235b.gpqa: winner={'value': 81.1, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- qwen3-235b.lcb: winner={'value': 74.48, 'trustScore': 0.4826, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-235b.aaIdx: winner={'value': 30.0, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-235b.tb2: winner={'value': 65.0, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-235b.hle: winner={'value': 42.0, 'trustScore': 0.4968, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-235b.aime26: winner={'value': 92.3, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- qwen3-32b.sweV: winner={'value': 72.0, 'trustScore': 0.4753, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-32b.lcb: winner={'value': 54.54, 'trustScore': 0.4826, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-32b.aaIdx: winner={'value': 76.4, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-32b.tb2: winner={'value': 56.3, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-32b.mmluPro: winner={'value': 79.1, 'trustScore': 0.4797, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-32b.cfElo: winner={'value': 1982.0, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-coder-next.sweV: winner={'value': 70.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
...
- qwen3-coder-next.lcb: winner={'value': 68.57, 'trustScore': 0.41, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen25-coder-32b.lcb: winner={'value': 48.69, 'trustScore': 0.4824, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen25-coder-32b.mmluPro: winner={'value': 78.2, 'trustScore': 0.4703, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen25-coder-14b.lcb: winner={'value': 37.6, 'trustScore': 0.4127, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen25-coder-7b.lcb: winner={'value': 37.6, 'trustScore': 0.2562, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
- qwen3-5-9b.sweV: winner={'value': 42.3, 'trustScore': 0.4753, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-5-9b.lcb: winner={'value': 65.6, 'trustScore': 0.4826, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- qwen3-5-9b.aaIdx: winner={'value': 25.0, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-01'} (severity=yellow, ΔNone)
- qwen3-5-9b.aaAgentic: winner={'value': 37.42, 'trustScore': 0.4925, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- mimo-v2-5.sweV: winner={'value': 78.9, 'trustScore': 0.4696, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- mimo-v2-5.gpqa: winner={'value': 86.6, 'trustScore': 0.407, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
- mimo-v2-5-pro.gpqa: winner={'value': 66.7, 'trustScore': 0.2867, 'tier': 'S', 'verifications': 6, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- mimo-v2-5-pro.lcb: winner={'value': 76.2, 'trustScore': 0.3986, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- glm-4-5-air.sweV: winner={'value': 57.6, 'trustScore': 0.4753, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- glm-4-7.sweV: winner={'value': 73.75, 'trustScore': 0.4753, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- glm-4-7.gpqa: winner={'value': 85.71, 'trustScore': 0.4855, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- glm-4-7.mmluPro: winner={'value': 84.3, 'trustScore': 0.4703, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- glm-4-7.tau2: winner={'value': 87.4, 'trustScore': 0.4723, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-07-01'} (severity=yellow, ΔNone)
- glm-5.hle: winner={'value': 30.5, 'trustScore': 0.4929, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- glm-5.tau2: winner={'value': 98.12, 'trustScore': 0.4902, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- glm-5-2.gpqa: winner={'value': 91.2, 'trustScore': 0.2867, 'tier': 'S', 'verifications': 4, 'latestDate': '2026-06-28'} (severity=yellow, ΔNone)
- glm-5-2.tb2: winner={'value': 81.0, 'trustScore': 0.3428, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-28'} (severity=yellow, ΔNone)
- minimax-m2-5.sweV: winner={'value': 80.2, 'trustScore': 0.4929, 'tier': 'I', 'verifications': 20, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- minimax-m2-5.gpqa: winner={'value': 85.1, 'trustScore': 0.4902, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- minimax-m2-5.lcb: winner={'value': 70.44, 'trustScore': 0.4826, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- minimax-m2-5.tb2: winner={'value': 52.0, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- minimax-m2-5.hle: winner={'value': 19.37, 'trustScore': 0.4968, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- minimax-m2-5.swePro: winner={'value': 55.49, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- minimax-m2-5.aime26: winner={'value': 88.75, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-7.sweV: winner={'value': 78.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-7.gpqa: winner={'value': 86.97, 'trustScore': 0.4855, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- minimax-m2-7.lcb: winner={'value': 80.05, 'trustScore': 0.4855, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-16'} (severity=yellow, ΔNone)
- minimax-m2-7.hle: winner={'value': 28.1, 'trustScore': 0.4968, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- minimax-m2-7.swePro: winner={'value': 56.21, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- minimax-m2-7.tau2: winner={'value': 84.8, 'trustScore': 0.4893, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-7.aime26: winner={'value': 94.2, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- minimax-m2-7.tbHard: winner={'value': 39.4, 'trustScore': 0.4977, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-1.sweV: winner={'value': 74.0, 'trustScore': 0.4696, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-16'} (severity=yellow, ΔNone)
- minimax-m2-1.gpqa: winner={'value': 82.88, 'trustScore': 0.4855, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-16'} (severity=yellow, ΔNone)
- minimax-m2-1.lcb: winner={'value': 86.0, 'trustScore': 0.4826, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- minimax-m2-1.hle: winner={'value': 22.2, 'trustScore': 0.4968, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-16'} (severity=yellow, ΔNone)
- minimax-m2-1.swePro: winner={'value': 36.81, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-1.tau2: winner={'value': 87.0, 'trustScore': 0.4893, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-16'} (severity=yellow, ΔNone)
- step-3-5-flash.sweV: winner={'value': 74.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- step-3-5-flash.gpqa: winner={'value': 83.19, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- step-3-5-flash.tb2: winner={'value': 51.0, 'trustScore': 0.4238, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- step-3-7-flash.tb2: winner={'value': 59.55, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- step-3-7-flash.aaIdx: winner={'value': 29.73, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- step-3-7-flash.tbHard: winner={'value': 32.6, 'trustScore': 0.4977, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
- gemma-3-27b.aaAgentic: winner={'value': 3.51, 'trustScore': 0.4925, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-15'} (severity=yellow, ΔNone)
...
- qwen3-6-35b-moe.aaCoding: winner={'value': 35.2, 'trustScore': 0.4965, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- muse-spark.aaCoding: winner={'value': 47.5, 'trustScore': 0.4965, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)

### Gaps (387 entries — agent:277 orchestrator:110 — see data/known-gaps.json or next refresh)
- `opus-4-7.tau2` *(agent)*: agent surveyed; value unavailable
- `opus-4-7.cfElo` *(agent)*: agent surveyed; value unavailable
- `opus-4-7.nl2Repo` *(agent)*: agent surveyed; value unavailable
- `sonnet-4-6.cfElo` *(agent)*: agent surveyed; value unavailable
...
## [2026-06-28] — autonomous refresh-all [WARN: cumulative provenance coverage 69.1% below 85% target] [WARN: runMetadata missing fields ['toolCallCount', 'fetchAttemptCount', 'batchCount']] [partial: gap-gen supplement: agent found 542 new fills; 127 cells auto-gapped by orchestrator; 439 explicit agent gaps preserved]

[fillRatio:0.69 cells:857/1241 contradictions:206 fetch:0.0min tools:None batches:None build:c930089]

### Added
- `kimi-k2-7-code-highspeed` (Moonshot AI) — throughput-optimized K2.7 Code variant (~180 tok/s), 256K context, MIT; surveyed same-cycle (no-defer)
- `qwen3-6-flash` (Alibaba Qwen) — API flash tier, 1M context, proprietary; surveyed same-cycle
- `nemotron-3-nano` (Nvidia) — text-only 30B/3.6B MoE, 1M context, NVIDIA Open Model License; surveyed same-cycle

### Deprecated
- `glm-5-1` (Z.ai) — superseded by `glm-5-2` (current flagship); retained faded, frozen at last-known data

### Lineup
- New-model net surfaced 8 candidates; 3 admitted, 5 gated (gpt-5-4-pro/claude-opus-4-6/gemini-3-flash superseded; minimax-m2-7-highspeed restricted; gpt-5-6-sol limited-preview not-GA)
- Verification flag: `grok-4-1-fast` absent from current xAI docs lineup (already deprecated in data)
- 🔎 New vendor candidates: 1 (Inception Labs / Mercury 2 — review queue)
- 🔎 New benchmark candidates: 2 pending, 0 AC6-ready (tb2-v2.1, FrontierSWE, Design Arena Elo — review queue)

### Anomaly verification (Layer-3, auto-dispatched)
- 5 cfElo Elo-trap suspects investigated → all CONFIRM (genuine Codeforces ratings): `deepseek-v4-pro`=3206, `gemma-4-31b`=2150 (quarantine cleared), `gemma-3-27b`=110, `gemma-4-e2b`=633, `gemma-4-e4b`=940 (small models score below human floor — real, not misfiles)

### Updated
- 35 models: `grok-4-20`, `glm-4-5-air`, `claude-fable-5`, `gemma-3-27b`, `qwen3-6-35b-moe`, `qwen3-6-27b`, `gemma-4-26b-moe`, `step-3-5-flash`, `qwen3-32b`, `gpt-5-5`, `qwen3-235b`, `minimax-m2-7`, `glm-5-2`, `kimi-k2-7-code`, `grok-4-3`, `deepseek-v4-pro`, `deepseek-coder-v2-16b`, `minimax-m2-1`, `gemini-3-1-flash`, `gemma-4-31b`, `llama-4-maverick`, `deepseek-v4-flash`, `gpt-5-4`, `qwen3-6-plus`, `glm-5-turbo`, `glm-5`, `claude-haiku-4-5`, `opus-4-7`, `qwen3-5-9b`, `mimo-v2-5-pro`, `qwen3-coder-30b`, `llama-4-scout`, `qwen25-coder-32b`, `nemotron-3-nano`, `nemotron-3-ultra`

### Resolved (auto via trustScore)
- opus-4-7.sweV: winner={'value': 87.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- opus-4-7.gpqa: winner={'value': 94.2, 'trustScore': 0.4791, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- opus-4-7.hle: winner={'value': 46.9, 'trustScore': 0.425, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- opus-4-7.mcpA: winner={'value': 77.56, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- opus-4-7.aaIdx: winner={'value': 57.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- opus-4-7.mmluPro: winner={'value': 89.87, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- claude-opus-4-8.sweV: winner={'value': 88.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-opus-4-8.hle: winner={'value': 49.8, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- sonnet-4-6.sweV: winner={'value': 79.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- sonnet-4-6.tb2: winner={'value': 59.1, 'trustScore': 0.425, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- sonnet-4-6.arcAgi2: winner={'value': 58.3, 'trustScore': 0.4363, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- claude-haiku-4-5.sweV: winner={'value': 73.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-haiku-4-5.gpqa: winner={'value': 67.2, 'trustScore': 0.4731, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- claude-haiku-4-5.aaIdx: winner={'value': 31.0, 'trustScore': 0.425, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-fable-5.lcb: winner={'value': 89.78, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-fable-5.hle: winner={'value': 64.5, 'trustScore': 0.4728, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-fable-5.aaIdx: winner={'value': 60.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- claude-fable-5.tb2: winner={'value': 88.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- claude-mythos-5.sweV: winner={'value': 93.9, 'trustScore': 0.4759, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- deepseek-v3-2.sweV: winner={'value': 67.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v3-2.lcb: winner={'value': 74.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- deepseek-v3-2.cfElo: winner={'value': 2386.0, 'trustScore': 0.3451, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v3-2.tb2: winner={'value': 46.4, 'trustScore': 0.4919, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v3-2.gpqa: winner={'value': 82.4, 'trustScore': 0.4128, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v3-2.hle: winner={'value': 24.86, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v3-2.mmluPro: winner={'value': 85.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v3-2.tau2: winner={'value': 71.3, 'trustScore': 0.425, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-22'} (severity=red, ΔNone)
- deepseek-v3-2.browseComp: winner={'value': 51.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- deepseek-v4-flash.swePro: winner={'value': 52.3, 'trustScore': 0.3954, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v4-flash.lcb: winner={'value': 91.44, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v4-flash.gpqa: winner={'value': 88.35, 'trustScore': 0.4856, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v4-flash.hle: winner={'value': 34.8, 'trustScore': 0.3426, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v4-pro.sweV: winner={'value': 80.6, 'trustScore': 0.4759, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v4-pro.swePro: winner={'value': 55.4, 'trustScore': 0.425, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v4-pro.lcb: winner={'value': 93.5, 'trustScore': 0.4828, 'tier': 'I', 'verifications': 21, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v4-pro.gpqa: winner={'value': 90.1, 'trustScore': 0.4791, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-coder-v2-16b.lcb: winner={'value': 43.4, 'trustScore': 0.425, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- gemini-3-1-flash.sweV: winner={'value': 78.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemini-3-1-flash.gpqa: winner={'value': 90.18, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemini-3-1-flash.hle: winner={'value': 35.0, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemini-3-1-flash.mmluPro: winner={'value': 89.0, 'trustScore': 0.4711, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemini-3-1-flash.aaIdx: winner={'value': 71.0, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- gemini-3-1-pro.gpqa: winner={'value': 94.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemini-3-1-pro.swePro: winner={'value': 54.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemini-3-1-pro.tau2: winner={'value': 76.5, 'trustScore': 0.4896, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- gemma-4-26b-moe.gpqa: winner={'value': 82.3, 'trustScore': 0.4791, 'tier': 'I', 'verifications': 23, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-31b.gpqa: winner={'value': 84.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 27, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-31b.tau2: winner={'value': 86.4, 'trustScore': 0.4896, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- gemma-4-31b.hle: winner={'value': 22.95, 'trustScore': 0.4905, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gemma-4-e2b.gpqa: winner={'value': 43.4, 'trustScore': 0.4791, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- llama-4-maverick.gpqa: winner={'value': 69.8, 'trustScore': 0.4295, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- llama-4-scout.gpqa: winner={'value': 57.21, 'trustScore': 0.4791, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- llama-4-scout.lcb: winner={'value': 32.8, 'trustScore': 0.4103, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- muse-spark.swePro: winner={'value': 52.4, 'trustScore': 0.4652, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- muse-spark.aaCoding: winner={'value': 58.62, 'trustScore': 0.4966, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- minimax-m2-7.gpqa: winner={'value': 86.97, 'trustScore': 0.4856, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- minimax-m2-7.tau2: winner={'value': 84.8, 'trustScore': 0.4896, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- minimax-m2-7.lcb: winner={'value': 80.05, 'trustScore': 0.4856, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
...
- minimax-m2-5.tau2: winner={'value': 95.32, 'trustScore': 0.4896, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
...
- minimax-m2-1.gpqa: winner={'value': 82.88, 'trustScore': 0.4856, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- minimax-m2-1.hle: winner={'value': 22.2, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- minimax-m2-1.lcb: winner={'value': 86.0, 'trustScore': 0.4128, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
- minimax-m2-1.swePro: winner={'value': 36.81, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-1.tau2: winner={'value': 87.0, 'trustScore': 0.4896, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- mistral-large-3.aaAgentic: winner={'value': 5.52, 'trustScore': 0.4928, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mistral-large-3.gpqa: winner={'value': 67.98, 'trustScore': 0.4791, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mistral-large-3.mmluPro: winner={'value': 73.11, 'trustScore': 0.425, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- mistral-large-3.lcb: winner={'value': 34.4, 'trustScore': 0.4831, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- mistral-large-3.tau2: winner={'value': 70.2, 'trustScore': 0.4896, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
...
- mistral-medium-3-5.gpqa: winner={'value': 71.22, 'trustScore': 0.4791, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- mistral-small-4.aaAgentic: winner={'value': 25.87, 'trustScore': 0.4928, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- codestral.sweV: winner={'value': 76.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-6.sweV: winner={'value': 80.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-6.tb2: winner={'value': 66.7, 'trustScore': 0.4182, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-6.lcb: winner={'value': 89.6, 'trustScore': 0.4128, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-6.hle: winner={'value': 54.0, 'trustScore': 0.4224, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-6.gpqa: winner={'value': 90.54, 'trustScore': 0.4856, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-6.sweMulti: winner={'value': 76.7, 'trustScore': 0.35, 'tier': 'S', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- gpt-5-5.sweV: winner={'value': 88.59, 'trustScore': 0.5, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gpt-5-5.tb2: winner={'value': 82.7, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- gpt-5-5.hle: winner={'value': 41.4, 'trustScore': 0.4728, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gpt-5-5.mrcr: winner={'value': 74.0, 'trustScore': 0.4182, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gpt-5-5-pro.hle: winner={'value': 43.1, 'trustScore': 0.4363, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
...
- qwen3-6-27b.lcb: winner={'value': 83.9, 'trustScore': 0.4103, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-max.tb2: winner={'value': 65.4, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- qwen3-6-max.gpqa: winner={'value': 86.0, 'trustScore': 0.4791, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- qwen3-6-max.hle: winner={'value': 51.0, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-235b.gpqa: winner={'value': 81.1, 'trustScore': 0.4128, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- qwen3-235b.lcb: winner={'value': 74.48, 'trustScore': 0.4828, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-235b.aime26: winner={'value': 92.3, 'trustScore': 0.3451, 'tier': 'S', 'verifications': 5, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- qwen3-32b.lcb: winner={'value': 54.54, 'trustScore': 0.4831, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-32b.aime26: winner={'value': 81.18, 'trustScore': 0.4606, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-6-35b-moe.gpqa: winner={'value': 86.0, 'trustScore': 0.2872, 'tier': 'S', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-35b-moe.tb2: winner={'value': 51.5, 'trustScore': 0.4856, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- qwen3-6-35b-moe.mcpA: winner={'value': 62.8, 'trustScore': 0.3426, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-35b-moe.aaAgentic: winner={'value': 21.41, 'trustScore': 0.4928, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-35b-moe.aaCoding: winner={'value': 35.2, 'trustScore': 0.4966, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-plus.aaIdx: winner={'value': 39.56, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-plus.sweV: winner={'value': 78.8, 'trustScore': 0.4704, 'tier': 'I', 'verifications': 19, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-plus.aaAgentic: winner={'value': 27.55, 'trustScore': 0.4928, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-plus.aime26: winner={'value': 75.3, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-6-plus.mmluPro: winner={'value': 88.5, 'trustScore': 0.4856, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
...
- qwen3-coder-30b.sweV: winner={'value': 51.25, 'trustScore': 0.4704, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-coder-30b.lcb: winner={'value': 56.53, 'trustScore': 0.4828, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- qwen3-coder-next.swePro: winner={'value': 44.3, 'trustScore': 0.425, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
...
- qwen3-coder-next.tb2: winner={'value': 36.2, 'trustScore': 0.3451, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- qwen25-coder-7b.sweV: winner={'value': 38.55, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen25-coder-14b.sweV: winner={'value': 27.99, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen25-coder-32b.lcb: winner={'value': 48.69, 'trustScore': 0.4828, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-5-9b.lcb: winner={'value': 65.6, 'trustScore': 0.4828, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- qwen3-5-9b.tau2: winner={'value': 86.84, 'trustScore': 0.4896, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-5-9b.aaCoding: winner={'value': 28.66, 'trustScore': 0.4966, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- qwen3-7-plus.gpqa: winner={'value': 92.4, 'trustScore': 0.4856, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)
- grok-4-20.aaIdx: winner={'value': 37.0, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- grok-4-20.gpqa: winner={'value': 88.02, 'trustScore': 0.4791, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- grok-4-20.hle: winner={'value': 24.25, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- grok-4-20.tau2: winner={'value': 93.0, 'trustScore': 0.4896, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- grok-4-20.tbHard: winner={'value': 16.7, 'trustScore': 0.4978, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- grok-4-20.aaAgentic: winner={'value': 53.86, 'trustScore': 0.4928, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- grok-4-20.lmArenaElo: winner={'value': 1471.0, 'trustScore': 0.17, 'tier': 'C', 'verifications': 1, 'latestDate': '2026-04-30'} (severity=red, ΔNone)
- grok-4-3.gpqa: winner={'value': 90.08, 'trustScore': 0.4856, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- grok-4-3.hle: winner={'value': 53.0, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- grok-4-3.tbHard: winner={'value': 18.9, 'trustScore': 0.4978, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- grok-4-3.aaAgentic: winner={'value': 24.1, 'trustScore': 0.4928, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mimo-v2-flash.gpqa: winner={'value': 83.83, 'trustScore': 0.4791, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- mimo-v2-flash.hle: winner={'value': 22.1, 'trustScore': 0.3451, 'tier': 'S', 'verifications': 7, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- mimo-v2-flash.lcb: winner={'value': 80.6, 'trustScore': 0.425, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- mimo-v2-flash.tb2: winner={'value': 38.5, 'trustScore': 0.4919, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
...
- mimo-v2-5-pro.tau2: winner={'value': 72.9, 'trustScore': 0.4162, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
- mimo-v2-5-pro.hle: winner={'value': 33.87, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- glm-4-5-air.gpqa: winner={'value': 79.1, 'trustScore': 0.3651, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- glm-4-5-air.lcb: winner={'value': 72.9, 'trustScore': 0.2567, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
...
- glm-4-5-air.aime26: winner={'value': 89.4, 'trustScore': 0.3915, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- glm-4-5-air.sweV: winner={'value': 57.6, 'trustScore': 0.4929, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- glm-4-7.sweV: winner={'value': 73.75, 'trustScore': 0.4759, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- glm-4-7.tau2: winner={'value': 87.4, 'trustScore': 0.4731, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-28'} (severity=yellow, ΔNone)
- glm-4-7.gpqa: winner={'value': 85.71, 'trustScore': 0.4856, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- glm-4-7.browseComp: winner={'value': 52.0, 'trustScore': 0.4919, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- glm-4-7.aime26: winner={'value': 95.7, 'trustScore': 0.4606, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-28'} (severity=yellow, ΔNone)
- glm-5.gpqa: winner={'value': 86.6, 'trustScore': 0.4295, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-28'} (severity=yellow, ΔNone)
- glm-5.hle: winner={'value': 30.5, 'trustScore': 0.4929, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-28'} (severity=yellow, ΔNone)
- glm-5.tau2: winner={'value': 98.12, 'trustScore': 0.4905, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- glm-5.aime26: winner={'value': 92.7, 'trustScore': 0.4929, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-28'} (severity=yellow, ΔNone)
- glm-5.mmluPro: winner={'value': 82.01, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-28'} (severity=yellow, ΔNone)
- glm-5-2.gpqa: winner={'value': 91.2, 'trustScore': 0.2872, 'tier': 'S', 'verifications': 4, 'latestDate': '2026-06-28'} (severity=yellow, ΔNone)
- glm-5-2.hle: winner={'value': 40.0, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- glm-5-2.tb2: winner={'value': 81.0, 'trustScore': 0.3426, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-28'} (severity=yellow, ΔNone)
- nemotron-3-super.sweV: winner={'value': 60.47, 'trustScore': 0.4929, 'tier': 'I', 'verifications': 21, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- nemotron-3-super.tb2: winner={'value': 29.0, 'trustScore': 0.4856, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- nemotron-3-super.aaIdx: winner={'value': 36.0, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- nemotron-3-ultra.aaIdx: winner={'value': 47.7, 'trustScore': 0.4994, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- step-3-5-flash.sweV: winner={'value': 74.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- step-3-5-flash.tb2: winner={'value': 51.0, 'trustScore': 0.4238, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- step-3-5-flash.hle: winner={'value': 22.57, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- step-3-7-flash.sweV: winner={'value': 76.5, 'trustScore': 0.3418, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-06-28'} (severity=yellow, ΔNone)
- step-3-7-flash.tb2: winner={'value': 59.5, 'trustScore': 0.3426, 'tier': 'S', 'verifications': 4, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
- step-3-7-flash.gpqa: winner={'value': 77.8, 'trustScore': 0.4856, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)

### Gaps (384 entries — agent:257 orchestrator:127 — see data/known-gaps.json or next refresh)
- `opus-4-7.tau2` *(agent)*: agent surveyed; value unavailable
- `opus-4-7.cfElo` *(agent)*: agent surveyed; value unavailable
- `opus-4-7.nl2Repo` *(agent)*: agent surveyed; value unavailable
- `claude-opus-4-8.tau2` *(agent)*: agent surveyed; value unavailable
- `claude-opus-4-8.cfElo` *(agent)*: agent surveyed; value unavailable
- `claude-opus-4-8.nl2Repo` *(agent)*: agent surveyed; value unavailable
- `codestral.aaIdx` *(orchestrator)*: not reached in agent survey cycle; AA Index data unavailable
