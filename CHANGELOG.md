...
## [2026-06-06] — autonomous refresh-all [WARN: cumulative provenance coverage 63.6% below 85% target] [WARN: runMetadata missing fields ['toolCallCount', 'fetchAttemptCount', 'batchCount']] [partial: gap-gen supplement: agent found 535 new fills; 68 cells auto-gapped by orchestrator; 377 explicit agent gaps preserved]

[fillRatio:0.64 cells:779/1224 contradictions:263 fetch:0.0min tools:None batches:None build:44aafe8]

### Added (lineup discovery — 4 new models)
- `nemotron-3-ultra` (Nvidia, open-flagship) — Nemotron 3 Ultra 550B, released 2026-06-04, OpenMDW-1.1, aaIdx=48. Stub; bench fills next cycle.
- `muse-spark` (Meta, frontier) — Muse Spark, released 2026-04-08, closed-weight, 262K ctx, aaIdx=52. Stub.
- `step-3-7-flash` (StepFun, open-flagship) — Step 3.7 Flash 198B MoE, released 2026-05-29, Apache-2.0, 256K ctx, $0.20/$1.15. Stub.
- `glm-5` (Z.ai, open-flagship) — GLM-5 744B MoE, released 2026-02-11 (missed prior refresh), MIT, 200K ctx. Stub.

### Flagged (lineup — review, not auto-applied)
- `grok-4-20` → `grok-4-3`: xAI docs show grok-4-3 supersedes grok-4-20 (legacy aliases redirected). Both currently active; deprecation deferred pending explicit vendor confirmation.

### Anomaly verdicts (OUTLIERS→INVESTIGATE, 12 confirm / 4 clear)
- Confirmed (kept): deepseek-v4-flash.cfElo=3052 (real Codeforces Elo), codestral-22b.gpqa=6.5 / mmluPro=24.0 (code-specialist near-random on knowledge), gpt-5-4-mini.aime26=6.67, gpt-5-4-nano.aime26=30.0, sonnet-4-6.aime26=63.3, +6 more.
- Cleared→gap (misparse/wrong-variant): mistral-large-3.aime26, mistral-large-3.gpqa, qwen3-coder-30b.gpqa, mimo-v2-5-pro.aime26.

### Updated
- 16 models: `minimax-m2-1`, `gemini-3-1-flash`, `qwen3-235b`, `glm-4-7`, `opus-4-7`, `deepseek-coder-v2-16b`, `mistral-large-3`, `mimo-v2-5-pro`, `deepseek-v4-flash`, `qwen25-coder-7b`, `qwen3-6-35b-moe`, `step-3-5-flash`, `gpt-5-4`, `qwen3-32b`, `gemma-4-26b-moe`, `deepseek-v4-pro`
...
- sonnet-4-6.sweV: winner={'value': 79.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- sonnet-4-6.tb2: winner={'value': 58.9, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- claude-haiku-4-5.tb2: winner={'value': 41.2, 'trustScore': 0.4737, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- claude-opus-4-8.hle: winner={'value': 49.8, 'trustScore': 0.4616, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- deepseek-v4-pro.lcb: winner={'value': 93.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-v4-pro.gpqa: winner={'value': 90.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- deepseek-v4-pro.aaIdx: winner={'value': 52.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-v4-flash.sweV: winner={'value': 79.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-v4-flash.lcb: winner={'value': 91.44, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-v3-2.sweV: winner={'value': 67.86, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- deepseek-v3-2.gpqa: winner={'value': 82.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-v3-2.lcb: winner={'value': 74.11, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- deepseek-v3-2.hle: winner={'value': 24.86, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
...
- deepseek-v3-2.aaIdx: winner={'value': 32.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-r1-14b.gpqa: winner={'value': 59.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-r1-14b.lcb: winner={'value': 53.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-r1-14b.aime26: winner={'value': 69.97, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-coder-v2-16b.lcb: winner={'value': 43.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemini-3-1-flash.gpqa: winner={'value': 90.19, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
...
- gemini-3-1-flash.hle: winner={'value': 34.58, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- gemini-3-1-pro.gpqa: winner={'value': 94.25, 'trustScore': 0.5, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemini-3-1-pro.hle: winner={'value': 44.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- gemini-3-1-pro.aaIdx: winner={'value': 57.02, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- gemma-3-27b.gpqa: winner={'value': 42.46, 'trustScore': 0.5, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemma-3-27b.tau2: winner={'value': 6.6, 'trustScore': 0.4737, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- gemma-4-26b-moe.gpqa: winner={'value': 82.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemma-4-26b-moe.tau2: winner={'value': 86.4, 'trustScore': 0.35, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemma-4-26b-moe.mmluPro: winner={'value': 82.6, 'trustScore': 0.4612, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-05-30'} (severity=yellow, ΔNone)
- gemma-4-31b.gpqa: winner={'value': 84.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemma-4-31b.lcb: winner={'value': 80.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 19, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemma-4-31b.tau2: winner={'value': 86.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemma-4-e2b.aime26: winner={'value': 37.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- gemini-3-5-flash.gpqa: winner={'value': 92.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
...
- gemini-3-1-pro.tbHard: winner={'value': 44.3, 'trustScore': 0.4697, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
...
- gemma-4-26b-moe.aaIdx: winner={'value': 31.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemma-4-e4b.aaIdx: winner={'value': 19.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- minimax-m2-5.sweV: winner={'value': 80.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- minimax-m2-5.gpqa: winner={'value': 85.14, 'trustScore': 0.5, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- minimax-m2-5.hle: winner={'value': 19.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- minimax-m2-5.aime26: winner={'value': 88.75, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- minimax-m2-5.mmluPro: winner={'value': 74.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
- minimax-m2-5.lcb: winner={'value': 70.44, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- minimax-m2-5.tb2: winner={'value': 52.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
- minimax-m2-5.aaAgentic: winner={'value': 56.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- minimax-m2-7.swePro: winner={'value': 56.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- minimax-m2-7.sweV: winner={'value': 78.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
- minimax-m2-7.tb2: winner={'value': 57.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- minimax-m2-7.gpqa: winner={'value': 86.97, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- minimax-m2-7.hle: winner={'value': 28.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- minimax-m2-7.aime26: winner={'value': 78.3, 'trustScore': 0.35, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
...
- minimax-m2-7.lcb: winner={'value': 80.05, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
...
- minimax-m2-1.gpqa: winner={'value': 82.87, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
...
- minimax-m2-1.tau2: winner={'value': 87.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mistral-large-3.gpqa: winner={'value': 43.9, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mistral-large-3.tau2: winner={'value': 70.2, 'trustScore': 0.4797, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-09'} (severity=red, ΔNone)
- mistral-large-3.tbHard: winner={'value': 15.91, 'trustScore': 0.4697, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mistral-large-3.lcb: winner={'value': 82.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mistral-large-3.mmluPro: winner={'value': 73.11, 'trustScore': 0.4808, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mistral-medium-3-5.sweV: winner={'value': 77.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mistral-small-4.gpqa: winner={'value': 71.2, 'trustScore': 0.2735, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- devstral-2.sweV: winner={'value': 72.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- gpt-5-5.hle: winner={'value': 41.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- gpt-5-5.aaIdx: winner={'value': 59.83, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gpt-5-4.swePro: winner={'value': 59.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gpt-5-4.sweV: winner={'value': 78.95, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gpt-5-4.gpqa: winner={'value': 92.39, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- gpt-5-4.hle: winner={'value': 39.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
- o3.sweV: winner={'value': 71.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- o3.gpqa: winner={'value': 87.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- o3.hle: winner={'value': 20.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- o3.tau2: winner={'value': 83.5, 'trustScore': 0.4797, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-18'} (severity=yellow, ΔNone)
...
- gpt-4-1.sweV: winner={'value': 54.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gpt-4-1.gpqa: winner={'value': 66.45, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gpt-4-1.swePro: winner={'value': 60.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-235b.gpqa: winner={'value': 81.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-235b.lcb: winner={'value': 74.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-235b.aime26: winner={'value': 92.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
- qwen3-235b.mmluPro: winner={'value': 84.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- qwen3-235b.hle: winner={'value': 42.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-235b.cfElo: winner={'value': 2056.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-32b.gpqa: winner={'value': 66.79, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-32b.aime26: winner={'value': 81.21, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-32b.lcb: winner={'value': 54.54, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-32b.mmluPro: winner={'value': 79.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-coder-480b.sweV: winner={'value': 69.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-coder-480b.swePro: winner={'value': 38.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-coder-480b.lcb: winner={'value': 68.0, 'trustScore': 0.4692, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-18'} (severity=red, ΔNone)
- qwen3-coder-30b.sweV: winner={'value': 51.28, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-coder-30b.gpqa: winner={'value': 43.9, 'trustScore': 0.3907, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-coder-30b.lcb: winner={'value': 56.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- qwen3-coder-next.tb2: winner={'value': 36.2, 'trustScore': 0.35, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-27b.sweV: winner={'value': 77.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-27b.swePro: winner={'value': 53.5, 'trustScore': 0.4737, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-27b.gpqa: winner={'value': 87.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-35b-moe.tb2: winner={'value': 51.5, 'trustScore': 0.35, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-35b-moe.gpqa: winner={'value': 86.0, 'trustScore': 0.35, 'tier': 'S', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-plus.sweV: winner={'value': 78.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-plus.tau2: winner={'value': 76.8, 'trustScore': 0.4797, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-6-plus.aaIdx: winner={'value': 50.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-max.gpqa: winner={'value': 86.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- qwen3-6-max.hle: winner={'value': 51.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-7-max.gpqa: winner={'value': 92.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- qwen3-7-max.hle: winner={'value': 41.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-7-max.sweV: winner={'value': 80.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- qwen25-coder-7b.sweV: winner={'value': 38.57, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-7-max.aime26: winner={'value': 97.1, 'trustScore': 0.2, 'tier': 'C', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-7-plus.gpqa: winner={'value': 92.4, 'trustScore': 0.2, 'tier': 'C', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- qwen3-7-plus.hle: winner={'value': 41.4, 'trustScore': 0.1954, 'tier': 'C', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-max.tau2: winner={'value': 95.9, 'trustScore': 0.5, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-plus.aaAgentic: winner={'value': 61.67, 'trustScore': 0.4697, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-plus.swePro: winner={'value': 56.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-6-35b-moe.swePro: winner={'value': 49.5, 'trustScore': 0.3832, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
- qwen3-6-35b-moe.aaIdx: winner={'value': 43.49, 'trustScore': 0.4916, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-5-9b.hle: winner={'value': 13.3, 'trustScore': 0.4608, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- qwen3-5-9b.tau2: winner={'value': 86.84, 'trustScore': 0.4697, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-5-9b.tbHard: winner={'value': 24.24, 'trustScore': 0.4697, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- qwen3-235b.tau2: winner={'value': 37.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-235b.aaIdx: winner={'value': 30.0, 'trustScore': 0.4916, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-32b.aaIdx: winner={'value': 76.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
- qwen3-6-35b-moe.aaCoding: winner={'value': 35.15, 'trustScore': 0.4697, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-35b-moe.aaAgentic: winner={'value': 58.34, 'trustScore': 0.4697, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-35b-moe.hle: winner={'value': 20.16, 'trustScore': 0.4608, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-05-31'} (severity=red, ΔNone)
- qwen3-6-35b-moe.tau2: winner={'value': 73.4, 'trustScore': 0.4797, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-05-10'} (severity=red, ΔNone)
- grok-3.sweV: winner={'value': 63.8, 'trustScore': 0.35, 'tier': 'S', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-3.gpqa: winner={'value': 84.23, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-3.lcb: winner={'value': 79.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-3.hle: winner={'value': 18.8, 'trustScore': 0.4608, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-18'} (severity=red, ΔNone)
- grok-3.aime26: winner={'value': 93.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-3-mini.gpqa: winner={'value': 79.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- grok-3-mini.lcb: winner={'value': 69.77, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-3-mini.aime26: winner={'value': 95.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- grok-4-20.aaIdx: winner={'value': 49.05, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-20.gpqa: winner={'value': 87.99, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-20.hle: winner={'value': 24.25, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-20.lcb: winner={'value': 79.29, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-20.aime26: winner={'value': 95.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
- grok-4-20.sweV: winner={'value': 77.06, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- grok-4-3.gpqa: winner={'value': 90.09, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-1-fast.gpqa: winner={'value': 85.32, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-1-fast.hle: winner={'value': 5.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-1-fast.tau2: winner={'value': 72.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- grok-4-1-fast.tbHard: winner={'value': 14.39, 'trustScore': 0.4697, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- mimo-v2-5-pro.aaAgentic: winner={'value': 68.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mimo-v2-5.gpqa: winner={'value': 86.6, 'trustScore': 0.439, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-22'} (severity=yellow, ΔNone)
- mimo-v2-5.hle: winner={'value': 33.8, 'trustScore': 0.4608, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-22'} (severity=red, ΔNone)
- mimo-v2-5.tau2: winner={'value': 94.2, 'trustScore': 0.4697, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-05-22'} (severity=yellow, ΔNone)
- mimo-v2-5.tbHard: winner={'value': 26.5, 'trustScore': 0.4697, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-05-09'} (severity=red, ΔNone)
- mimo-v2-flash.gpqa: winner={'value': 83.86, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mimo-v2-flash.hle: winner={'value': 22.1, 'trustScore': 0.35, 'tier': 'S', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mimo-v2-flash.lcb: winner={'value': 80.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mimo-v2-flash.tb2: winner={'value': 38.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mimo-v2-flash.mmluPro: winner={'value': 84.9, 'trustScore': 0.3358, 'tier': 'S', 'verifications': 4, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
- mimo-v2-pro.gpqa: winner={'value': 86.95, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- mimo-v2-pro.tau2: winner={'value': 95.03, 'trustScore': 0.4697, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mimo-v2-pro.sweV: winner={'value': 77.99, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mimo-v2-5-pro.aime26: winner={'value': 37.3, 'trustScore': 0.3253, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-05-30'} (severity=yellow, ΔNone)
- mimo-v2-flash.aime26: winner={'value': 94.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-4-7.sweV: winner={'value': 73.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-4-7.tau2: winner={'value': 87.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-4-7.gpqa: winner={'value': 85.71, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-4-7.hle: winner={'value': 42.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
...
- glm-5-1.gpqa: winner={'value': 86.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-5-1.hle: winner={'value': 52.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- glm-5-1.aaIdx: winner={'value': 51.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-5-1.tau2: winner={'value': 97.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-4-7.aaCoding: winner={'value': 23.82, 'trustScore': 0.4697, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-4-7.aaAgentic: winner={'value': 21.01, 'trustScore': 0.4697, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- glm-4-7.tbHard: winner={'value': 31.8, 'trustScore': 0.4508, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- llama-4-maverick.sweV: winner={'value': 76.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
- llama-4-maverick.lcb: winner={'value': 43.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- llama-4-maverick.gpqa: winner={'value': 69.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- llama-4-scout.lcb: winner={'value': 32.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- llama-4-scout.mmluPro: winner={'value': 74.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- llama-4-scout.gpqa: winner={'value': 57.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- nemotron-3-super.sweV: winner={'value': 60.47, 'trustScore': 0.5, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- nemotron-3-super.gpqa: winner={'value': 79.25, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- nemotron-3-super.lcb: winner={'value': 81.09, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- nemotron-3-super.tbHard: winner={'value': 29.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=yellow, ΔNone)
- nemotron-3-nano-omni.gpqa: winner={'value': 72.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- nemotron-3-nano-omni.tau2: winner={'value': 42.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-05-30'} (severity=yellow, ΔNone)
- nemotron-3-nano-omni.lcb: winner={'value': 63.2, 'trustScore': 0.4551, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- step-3-5-flash.sweV: winner={'value': 74.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- step-3-5-flash.tb2: winner={'value': 51.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- step-3-5-flash.hle: winner={'value': 22.57, 'trustScore': 0.4608, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- step-3-5-flash.aaCoding: winner={'value': 34.56, 'trustScore': 0.4697, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- step-3-5-flash.aaAgentic: winner={'value': 48.23, 'trustScore': 0.4697, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- step-3-5-flash.gpqa: winner={'value': 83.23, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- kimi-k2-6.sweV: winner={'value': 80.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- kimi-k2-6.swePro: winner={'value': 58.6, 'trustScore': 0.4508, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- kimi-k2-6.hle: winner={'value': 54.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- kimi-k2-6.gpqa: winner={'value': 90.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- kimi-k2-6.lcb: winner={'value': 89.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- kimi-k2-6.tb2: winner={'value': 66.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- kimi-k2-6.tau2: winner={'value': 70.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- glm-4-5-air.aaIdx: winner={'value': 23.17, 'trustScore': 0.4916, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-3.aaAgentic: winner={'value': 67.8, 'trustScore': 0.4697, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-05-27'} (severity=yellow, ΔNone)
- opus-4-7.aaCoding: winner={'value': 53.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)

### Gaps (445 entries — agent:243 orchestrator:202 — see data/known-gaps.json or next refresh)
