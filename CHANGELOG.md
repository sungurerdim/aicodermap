...
## [2026-06-07] — autonomous refresh-all [WARN: cumulative provenance coverage 67.1% below 85% target] [WARN: runMetadata missing fields ['toolCallCount', 'fetchAttemptCount', 'batchCount']] [partial: gap-gen supplement: agent found 615 new fills; 6 cells auto-gapped by orchestrator; 738 explicit agent gaps preserved]

[fillRatio:0.67 cells:867/1292 contradictions:303 fetch:0.0min tools:None batches:None build:694db97]

### Updated
- 53 models: `deepseek-v4-pro`, `sonnet-4-6`, `gemma-4-e2b`, `minimax-m2-5`, `glm-5`, `glm-5-turbo`, `mimo-v2-5`, `qwen3-coder-30b`, `muse-spark`, `qwen3-6-35b-moe`, `llama-4-scout`, `gpt-5-4`, `gpt-5-5`, `nemotron-3-super`, `glm-4-7`, `deepseek-v3-2`, `mistral-large-3`, `qwen3-6-max`, `deepseek-r1-14b`, `mistral-medium-3-5`, `mimo-v2-5-pro`, `qwen3-7-max`, `step-3-5-flash`, `opus-4-7`, `qwen3-6-27b`, `minimax-m2-7`, `gemma-3-27b`, `gemma-4-e4b`, `qwen3-5-9b`, `gpt-5-4-nano`, `deepseek-v4-flash`, `qwen25-coder-7b`, `devstral-small-2`, `nemotron-3-nano-omni`, `grok-4-3`, `gemini-3-1-flash`, `qwen3-coder-next`, `deepseek-coder-v2-16b`, `mimo-v2-pro`, `qwen3-6-plus`, `qwen3-235b`, `grok-4-20`, `minimax-m2-1`, `qwen25-coder-32b`, `gemma-4-31b`, `qwen3-32b`, `glm-4-5-air`, `grok-3`, `glm-5-1`, `o4-mini`, `gemini-3-1-pro`, `step-3-7-flash`, `claude-opus-4-8`
...
- gemini-3-1-flash.lcb: winner={'value': 90.97, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- gemini-3-1-pro.aaIdx: winner={'value': 57.02, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
- gemini-3-1-pro.swePro: winner={'value': 54.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gemini-3-1-pro.gpqa: winner={'value': 94.25, 'trustScore': 0.5, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gemini-3-1-pro.hle: winner={'value': 44.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- gemma-3-27b.gpqa: winner={'value': 42.47, 'trustScore': 0.5, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gemma-3-27b.tau2: winner={'value': 6.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- gemma-4-26b-moe.gpqa: winner={'value': 82.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gemma-4-26b-moe.mmluPro: winner={'value': 82.76, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
- gemma-4-26b-moe.hle: winner={'value': 22.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- gemma-4-31b.gpqa: winner={'value': 84.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gemma-4-31b.lcb: winner={'value': 80.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 21, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gemma-4-31b.tau2: winner={'value': 86.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemma-4-31b.hle: winner={'value': 23.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gemma-4-e2b.gpqa: winner={'value': 43.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gemma-4-e2b.aime26: winner={'value': 37.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- mistral-large-3.gpqa: winner={'value': 67.98, 'trustScore': 0.4803, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- mistral-large-3.mmluPro: winner={'value': 73.11, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- devstral-2.gpqa: winner={'value': 59.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- devstral-small-2.lcb: winner={'value': 33.7, 'trustScore': 0.4875, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-05-09'} (severity=red, ΔNone)
- gpt-5-5.sweV: winner={'value': 88.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gpt-5-5.swePro: winner={'value': 58.51, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- gpt-5-4.sweV: winner={'value': 78.94, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gpt-5-4.swePro: winner={'value': 59.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gpt-5-4.gpqa: winner={'value': 92.33, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- o3.gpqa: winner={'value': 87.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
- o3.hle: winner={'value': 20.24, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- o3.aime26: winner={'value': 88.9, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- o3.cfElo: winner={'value': 2727.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- o3.tau2: winner={'value': 83.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- o4-mini.sweV: winner={'value': 68.18, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- o4-mini.aime26: winner={'value': 92.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gpt-4-1.sweV: winner={'value': 54.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gpt-4-1.gpqa: winner={'value': 66.46, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- qwen3-6-max.sweV: winner={'value': 70.87, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-6-max.gpqa: winner={'value': 86.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
- qwen3-6-max.hle: winner={'value': 51.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-6-max.tau2: winner={'value': 95.91, 'trustScore': 0.5, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-6-max.tb2: winner={'value': 65.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
- qwen3-6-max.lcb: winner={'value': 77.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-235b.sweV: winner={'value': 79.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- qwen3-235b.lcb: winner={'value': 74.48, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-235b.bfcl: winner={'value': 70.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
- qwen3-235b.aime26: winner={'value': 92.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-235b.mmluPro: winner={'value': 84.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
- qwen3-235b.tb2: winner={'value': 65.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- qwen3-32b.sweV: winner={'value': 72.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-32b.lcb: winner={'value': 54.54, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-32b.aime26: winner={'value': 81.21, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-32b.mmluPro: winner={'value': 79.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-32b.bfcl: winner={'value': 75.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-32b.tb2: winner={'value': 56.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- qwen3-6-35b-moe.hle: winner={'value': 20.16, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- qwen3-6-plus.swePro: winner={'value': 56.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-6-plus.aime26: winner={'value': 75.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-6-plus.mmluPro: winner={'value': 88.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
...
- qwen3-coder-30b.sweV: winner={'value': 51.22, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-coder-next.sweV: winner={'value': 70.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-coder-next.swePro: winner={'value': 44.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- grok-3-mini.aime26: winner={'value': 95.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
- grok-3-mini.aaIdx: winner={'value': 32.04, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- grok-4-20.aaIdx: winner={'value': 49.07, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- grok-4-20.gpqa: winner={'value': 88.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- grok-4-20.hle: winner={'value': 24.29, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- grok-4-1-fast.tbHard: winner={'value': 14.39, 'trustScore': 0.5, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- deepseek-v3-2.sweV: winner={'value': 67.86, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- deepseek-v3-2.mmluPro: winner={'value': 85.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- deepseek-v3-2.cfElo: winner={'value': 2386.0, 'trustScore': 0.35, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- deepseek-v3-2.tau2: winner={'value': 71.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-v4-pro.sweV: winner={'value': 80.57, 'trustScore': 0.5, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- deepseek-v4-pro.lcb: winner={'value': 93.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- deepseek-v4-flash.lcb: winner={'value': 91.44, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- kimi-k2-6.sweV: winner={'value': 80.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- kimi-k2-6.swePro: winner={'value': 58.6, 'trustScore': 0.472, 'tier': 'I', 'verifications': 19, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- kimi-k2-6.lcb: winner={'value': 89.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- kimi-k2-6.gpqa: winner={'value': 90.54, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- deepseek-r1-14b.lcb: winner={'value': 53.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- deepseek-r1-14b.aime26: winner={'value': 70.02, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- glm-5-1.aaIdx: winner={'value': 51.12, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- glm-4-5-air.sweV: winner={'value': 57.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- glm-4-5-air.tb2: winner={'value': 30.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- glm-5.tau2: winner={'value': 97.97, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gpt-5-4-nano.gpqa: winner={'value': 81.7, 'trustScore': 0.4808, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- opus-4-7.swePro: winner={'value': 64.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- opus-4-7.gpqa: winner={'value': 94.29, 'trustScore': 0.5, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
- opus-4-7.mmluPro: winner={'value': 89.87, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
...
- opus-4-7.arcAgi2: winner={'value': 75.81, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- opus-4-7.aime26: winner={'value': 95.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- sonnet-4-6.sweV: winner={'value': 79.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- sonnet-4-6.mmluPro: winner={'value': 79.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- sonnet-4-6.lcb: winner={'value': 80.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- mistral-medium-3-5.sweV: winner={'value': 77.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- mistral-small-4.gpqa: winner={'value': 71.2, 'trustScore': 0.35, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- minimax-m2-5.sweV: winner={'value': 80.2, 'trustScore': 0.5, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- minimax-m2-5.gpqa: winner={'value': 85.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- minimax-m2-7.sweV: winner={'value': 78.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- minimax-m2-7.swePro: winner={'value': 56.21, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- minimax-m2-7.tb2: winner={'value': 57.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- minimax-m2-1.swePro: winner={'value': 36.81, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- minimax-m3.mmluPro: winner={'value': 84.22, 'trustScore': 0.35, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- step-3-5-flash.sweV: winner={'value': 74.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- step-3-5-flash.gpqa: winner={'value': 83.19, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- step-3-5-flash.hle: winner={'value': 22.75, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- step-3-5-flash.mmluPro: winner={'value': 84.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- step-3-5-flash.tb2: winner={'value': 51.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- step-3-7-flash.sweV: winner={'value': 74.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- step-3-7-flash.gpqa: winner={'value': 77.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- step-3-7-flash.hle: winner={'value': 47.2, 'trustScore': 0.3433, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- step-3-7-flash.tb2: winner={'value': 59.55, 'trustScore': 0.35, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- step-3-7-flash.aaAgentic: winner={'value': 48.23, 'trustScore': 0.4961, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- mimo-v2-flash.tb2: winner={'value': 38.5, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- mimo-v2-flash.aaIdx: winner={'value': 30.35, 'trustScore': 0.5, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- mimo-v2-flash.aaCoding: winner={'value': 25.81, 'trustScore': 0.4983, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- mimo-v2-flash.aaAgentic: winner={'value': 47.34, 'trustScore': 0.4961, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- mimo-v2-pro.sweV: winner={'value': 77.99, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- mimo-v2-pro.hle: winner={'value': 28.31, 'trustScore': 0.4984, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mimo-v2-pro.tau2: winner={'value': 95.01, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mimo-v2-5.sweV: winner={'value': 78.9, 'trustScore': 0.35, 'tier': 'S', 'verifications': 4, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
...
- gemma-4-e4b.aime26: winner={'value': 42.5, 'trustScore': 0.487, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemma-4-e4b.lcb: winner={'value': 52.0, 'trustScore': 0.4875, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- gemma-4-e4b.tau2: winner={'value': 42.2, 'trustScore': 0.332, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- llama-4-scout.gpqa: winner={'value': 57.21, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- llama-4-scout.mmluPro: winner={'value': 74.26, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- llama-4-scout.lcb: winner={'value': 32.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- muse-spark.hle: winner={'value': 39.9, 'trustScore': 0.4984, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- nemotron-3-super.sweV: winner={'value': 60.47, 'trustScore': 0.5, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- nemotron-3-super.lcb: winner={'value': 81.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
- nemotron-3-super.gpqa: winner={'value': 79.27, 'trustScore': 0.5, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
- nemotron-3-super.tb2: winner={'value': 29.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
...
- nemotron-3-super.tau2: winner={'value': 67.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- nemotron-3-nano-omni.gpqa: winner={'value': 72.47, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- nemotron-3-nano-omni.lcb: winner={'value': 68.25, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- nemotron-3-nano-omni.hle: winner={'value': 10.57, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- nemotron-3-nano-omni.tau2: winner={'value': 49.04, 'trustScore': 0.5, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- qwen3-5-9b.mmluPro: winner={'value': 82.5, 'trustScore': 0.4855, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
...
- qwen3-7-max.gpqa: winner={'value': 92.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-07'} (severity=yellow, ΔNone)
- qwen3-7-max.lcb: winner={'value': 91.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-7-max.hle: winner={'value': 41.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- qwen3-7-plus.sweV: winner={'value': 78.8, 'trustScore': 0.2, 'tier': 'C', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
### Gaps (425 entries — agent:419 orchestrator:6 — see data/known-gaps.json or next refresh)
...
- `codestral-22b.aaAgentic` *(orchestrator)*: not reached in agent survey cycle; AA Agentic data unavailable
- ... and 417 more
