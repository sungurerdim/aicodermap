...
## [2026-07-16] — autonomous refresh-all [WARN: cumulative provenance coverage 67.8% below 85% target] [WARN: runMetadata missing fields ['toolCallCount', 'fetchAttemptCount', 'batchCount']] [partial: gap-gen supplement: agent found 482 new fills; 193 cells auto-gapped by orchestrator; 505 explicit agent gaps preserved]

[fillRatio:0.68 cells:911/1343 contradictions:162 fetch:0.0min tools:None batches:None build:89a5dba]

### Updated
- 51 models: `claude-fable-5`, `claude-mythos-preview`, `glm-4-7`, `grok-4-3`, `opus-4-7`, `mistral-medium-3-5`, `minimax-m2-5`, `qwen3-6-35b-moe`, `gemini-3-1-flash`, `llama-4-maverick`, `gemma-4-e2b`, `gemini-3-flash-preview`, `step-3-7-flash`, `gpt-5-6-sol`, `muse-spark`, `mimo-v2-5`, `ministral-3-3b`, `gpt-5-6-terra`, `nemotron-3-super`, `grok-4-20`, `nemotron-3-nano`, `nemotron-3-ultra`, `qwen3-6-27b`, `minimax-m3`, `qwen3-5-9b`, `gemma-3-27b`, `kimi-k2-6`, `gemma-4-12b`, `deepseek-v3-2`, `minimax-m2-7`, `gemma-4-e4b`, `glm-5`, `claude-opus-4-8`, `qwen3-coder-next`, `gpt-5-6-luna`, `codestral`, `glm-5-turbo`, `kimi-k2-7-code`, `glm-5v-turbo`, `deepseek-v4-pro`, `glm-4-5-air`, `llama-4-scout`, `qwen3-7-max`, `grok-build-0-1`, `qwen3-coder-30b`, `deepseek-v4-flash`, `qwen25-coder-7b`, `mimo-v2-5-pro`, `gemini-3-1-flash-lite`, `ministral-3-14b`, `sonnet-4-6`
...
- gemini-3-1-pro.tau2: winner={'value': 76.5, 'trustScore': 0.4172, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
...
- gemma-4-26b-moe.gpqa: winner={'value': 82.3, 'trustScore': 0.487, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- gemma-4-31b.gpqa: winner={'value': 84.3, 'trustScore': 0.425, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- gemma-4-31b.tau2: winner={'value': 86.4, 'trustScore': 0.4114, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gemma-4-e4b.gpqa: winner={'value': 58.6, 'trustScore': 0.4172, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
...
- gemma-4-12b.gpqa: winner={'value': 78.8, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- gemma-4-12b.hle: winner={'value': 5.2, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- gemma-4-12b.tau2: winner={'value': 69.0, 'trustScore': 0.3409, 'tier': 'S', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- gemini-3-flash-preview.gpqa: winner={'value': 90.4, 'trustScore': 0.4733, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- gemini-3-flash-preview.hle: winner={'value': 33.7, 'trustScore': 0.4733, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- gemini-3-1-flash-lite.gpqa: winner={'value': 82.2, 'trustScore': 0.484, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- opus-4-7.sweV: winner={'value': 87.6, 'trustScore': 0.4624, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- opus-4-7.swePro: winner={'value': 64.3, 'trustScore': 0.4587, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- opus-4-7.tb2: winner={'value': 69.1, 'trustScore': 0.425, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- opus-4-7.gpqa: winner={'value': 94.2, 'trustScore': 0.4535, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- opus-4-7.hle: winner={'value': 46.9, 'trustScore': 0.4535, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- opus-4-7.mrcr: winner={'value': 32.2, 'trustScore': 0.425, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- sonnet-4-6.sweV: winner={'value': 79.6, 'trustScore': 0.4489, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- sonnet-4-6.tb2: winner={'value': 59.1, 'trustScore': 0.484, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- sonnet-4-6.gpqa: winner={'value': 74.1, 'trustScore': 0.425, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
- sonnet-4-6.hle: winner={'value': 51.0, 'trustScore': 0.4943, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- sonnet-4-6.mmluPro: winner={'value': 79.2, 'trustScore': 0.484, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- sonnet-4-6.tau2: winner={'value': 87.5, 'trustScore': 0.484, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- claude-haiku-4-5.sweV: winner={'value': 73.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- claude-haiku-4-5.swePro: winner={'value': 39.5, 'trustScore': 0.425, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
...
- claude-opus-4-8.hle: winner={'value': 49.8, 'trustScore': 0.4201, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- claude-fable-5.tb2: winner={'value': 88.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- claude-mythos-5.tau2: winner={'value': 98.5, 'trustScore': 0.484, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mistral-large-3.gpqa: winner={'value': 67.98, 'trustScore': 0.4023, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- mistral-large-3.aaIdx: winner={'value': 15.93, 'trustScore': 0.499, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
...
- mistral-medium-3-5.sweV: winner={'value': 77.6, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- mistral-medium-3-5.tau2: winner={'value': 91.4, 'trustScore': 0.4114, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
...
- qwen3-6-27b.gpqa: winner={'value': 87.8, 'trustScore': 0.484, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-6-27b.lcb: winner={'value': 83.9, 'trustScore': 0.484, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-6-27b.tau2: winner={'value': 76.8, 'trustScore': 0.407, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-6-35b-moe.tb2: winner={'value': 51.5, 'trustScore': 0.484, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
...
- qwen3-6-35b-moe.gpqa: winner={'value': 86.0, 'trustScore': 0.484, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- qwen3-6-35b-moe.lcb: winner={'value': 80.4, 'trustScore': 0.484, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- qwen3-6-35b-moe.tau2: winner={'value': 95.3, 'trustScore': 0.484, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-6-max.aaIdx: winner={'value': 40.0, 'trustScore': 0.499, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-32b.gpqa: winner={'value': 54.6, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- qwen3-32b.aaIdx: winner={'value': 76.4, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
...
- qwen3-coder-30b.sweV: winner={'value': 51.9, 'trustScore': 0.4918, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
...
- glm-4-5-air.gpqa: winner={'value': 79.1, 'trustScore': 0.4172, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- glm-4-5-air.hle: winner={'value': 13.3, 'trustScore': 0.418, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- glm-4-5-air.tau2: winner={'value': 77.9, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- glm-4-7.gpqa: winner={'value': 85.86, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- glm-4-7.hle: winner={'value': 42.8, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- glm-4-7.aime26: winner={'value': 95.7, 'trustScore': 0.4114, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-15'} (severity=yellow, ΔNone)
- glm-4-7.tau2: winner={'value': 87.4, 'trustScore': 0.4172, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- glm-5.gpqa: winner={'value': 86.6, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- glm-5.aime26: winner={'value': 92.7, 'trustScore': 0.4733, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- glm-5.mmluPro: winner={'value': 81.3, 'trustScore': 0.283, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-06-15'} (severity=yellow, ΔNone)
- glm-5.hle: winner={'value': 30.5, 'trustScore': 0.418, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- glm-5.tau2: winner={'value': 97.97, 'trustScore': 0.409, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- glm-5-2.hle: winner={'value': 40.13, 'trustScore': 0.4943, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- deepseek-v3-2.sweV: winner={'value': 67.86, 'trustScore': 0.425, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- deepseek-v3-2.tb2: winner={'value': 46.4, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- deepseek-v4-flash.tau2: winner={'value': 95.03, 'trustScore': 0.4812, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- deepseek-v4-flash.tbHard: winner={'value': 34.1, 'trustScore': 0.4693, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- deepseek-v4-flash.tb2: winner={'value': 56.9, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- deepseek-v4-flash.hle: winner={'value': 34.8, 'trustScore': 0.2898, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- deepseek-v4-flash.gpqa: winner={'value': 89.39, 'trustScore': 0.4733, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- deepseek-v4-pro.tau2: winner={'value': 96.2, 'trustScore': 0.4812, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- deepseek-v4-pro.tb2: winner={'value': 67.9, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- deepseek-v4-pro.hle: winner={'value': 37.7, 'trustScore': 0.4201, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-15'} (severity=yellow, ΔNone)
- deepseek-v4-pro.gpqa: winner={'value': 90.1, 'trustScore': 0.4733, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- deepseek-r1-14b.gpqa: winner={'value': 59.1, 'trustScore': 0.4799, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- deepseek-r1-14b.mmluPro: winner={'value': 93.9, 'trustScore': 0.2849, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
...
- ministral-3-3b.gpqa: winner={'value': 35.76, 'trustScore': 0.4733, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
...
- nemotron-3-super.gpqa: winner={'value': 79.23, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
...
- nemotron-3-nano.gpqa: winner={'value': 72.5, 'trustScore': 0.3409, 'tier': 'S', 'verifications': 4, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- nemotron-3-nano.hle: winner={'value': 10.57, 'trustScore': 0.3442, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-07-01'} (severity=yellow, ΔNone)
...
- claude-sonnet-5.hle: winner={'value': 57.4, 'trustScore': 0.4535, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- claude-sonnet-5.sweV: winner={'value': 85.2, 'trustScore': 0.4624, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- claude-mythos-preview.hle: winner={'value': 64.7, 'trustScore': 0.2, 'tier': 'C', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
...
- qwen3-7-plus.hle: winner={'value': 34.7, 'trustScore': 0.484, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- kimi-k2-6.sweV: winner={'value': 80.2, 'trustScore': 0.425, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- kimi-k2-6.sweMulti: winner={'value': 76.7, 'trustScore': 0.35, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- kimi-k2-6.tb2: winner={'value': 66.7, 'trustScore': 0.4172, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- kimi-k2-6.lcb: winner={'value': 89.6, 'trustScore': 0.4114, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- kimi-k2-6.gpqa: winner={'value': 90.51, 'trustScore': 0.4172, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- kimi-k2-6.hle: winner={'value': 54.0, 'trustScore': 0.4201, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- grok-4-20.sweV: winner={'value': 76.7, 'trustScore': 0.4489, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- grok-4-20.swePro: winner={'value': 51.8, 'trustScore': 0.484, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- grok-4-20.lcb: winner={'value': 79.28, 'trustScore': 0.4029, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- grok-4-20.gpqa: winner={'value': 88.5, 'trustScore': 0.484, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- grok-4-20.hle: winner={'value': 24.25, 'trustScore': 0.4201, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- grok-4-20.tb2: winner={'value': 47.1, 'trustScore': 0.484, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- grok-4-20.arcAgi2: winner={'value': 15.9, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- grok-4-20.aaAgentic: winner={'value': 53.86, 'trustScore': 0.4161, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- grok-4-3.gpqa: winner={'value': 90.1, 'trustScore': 0.484, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- grok-4-3.hle: winner={'value': 53.0, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- grok-4-3.tbHard: winner={'value': 18.9, 'trustScore': 0.4215, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- grok-4-20-multi-agent.gpqa: winner={'value': 87.7, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-28'} (severity=red, ΔNone)
...
- step-3-7-flash.gpqa: winner={'value': 77.8, 'trustScore': 0.4114, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- step-3-7-flash.tau2: winner={'value': 88.2, 'trustScore': 0.409, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
...
- llama-4-scout.gpqa: winner={'value': 58.7, 'trustScore': 0.484, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- llama-4-scout.lcb: winner={'value': 32.8, 'trustScore': 0.4029, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- minimax-m2-5.gpqa: winner={'value': 85.1, 'trustScore': 0.4172, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- minimax-m2-5.hle: winner={'value': 19.37, 'trustScore': 0.4201, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- minimax-m2-5.swePro: winner={'value': 55.49, 'trustScore': 0.425, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- minimax-m2-7.swePro: winner={'value': 56.2, 'trustScore': 0.484, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- minimax-m2-7.sweV: winner={'value': 78.0, 'trustScore': 0.4489, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-7.gpqa: winner={'value': 87.0, 'trustScore': 0.484, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- minimax-m2-7.tau2: winner={'value': 84.8, 'trustScore': 0.484, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- minimax-m2-7.aime26: winner={'value': 94.2, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- muse-spark.hle: winner={'value': 39.9, 'trustScore': 0.4943, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- mimo-v2-5.aaIdx: winner={'value': 40.0, 'trustScore': 0.499, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)
- mimo-v2-5.aaCoding: winner={'value': 42.13, 'trustScore': 0.4203, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- mimo-v2-5.aaAgentic: winner={'value': 65.53, 'trustScore': 0.4161, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- mimo-v2-5.tau2: winner={'value': 94.2, 'trustScore': 0.409, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- mimo-v2-5.tbHard: winner={'value': 41.67, 'trustScore': 0.4959, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- mimo-v2-5.tb2: winner={'value': 65.8, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- mimo-v2-5.hle: winner={'value': 33.8, 'trustScore': 0.4201, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-22'} (severity=red, ΔNone)
- mimo-v2-5.gpqa: winner={'value': 86.6, 'trustScore': 0.4023, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-22'} (severity=yellow, ΔNone)
- mimo-v2-5-pro.tau2: winner={'value': 94.15, 'trustScore': 0.4812, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- mimo-v2-5-pro.tb2: winner={'value': 68.4, 'trustScore': 0.4909, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- mimo-v2-5-pro.hle: winner={'value': 33.78, 'trustScore': 0.4943, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- mimo-v2-5-pro.gpqa: winner={'value': 66.7, 'trustScore': 0.3409, 'tier': 'S', 'verifications': 6, 'latestDate': '2026-07-16'} (severity=red, ΔNone)
- mimo-v2-5-pro.lcb: winner={'value': 76.2, 'trustScore': 0.425, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- mimo-v2-5-pro.webDevElo: winner={'value': 1479.0, 'trustScore': 0.425, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-04-30'} (severity=red, ΔNone)
- kimi-k2-6.aaCoding: winner={'value': 56.03, 'trustScore': 0.4945, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-01'} (severity=red, ΔNone)
- qwen3-5-9b.aaCoding: winner={'value': 25.3, 'trustScore': 0.4945, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
...
- step-3-7-flash.aaCoding: winner={'value': 39.57, 'trustScore': 0.4945, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-07-16'} (severity=yellow, ΔNone)
- gpt-5-6-sol.aaCoding: winner={'value': 80.0, 'trustScore': 0.4945, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-07-11'} (severity=yellow, ΔNone)
- opus-4-7.aaIdx: winner={'value': 57.0, 'trustScore': 0.499, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-24'} (severity=yellow, ΔNone)
