...
## [2026-06-27] — autonomous refresh-all [WARN: cumulative provenance coverage 70.8% below 85% target] [WARN: runMetadata missing fields ['toolCallCount', 'fetchAttemptCount', 'batchCount']] [partial: gap-gen supplement: agent found 543 new fills; 0 cells auto-gapped by orchestrator; 547 explicit agent gaps preserved]

[fillRatio:0.71 cells:830/1173 contradictions:220 fetch:0.0min tools:None batches:None build:2653190]

### Updated
- 41 models: `deepseek-v4-flash`, `llama-4-maverick`, `codestral`, `minimax-m2-1`, `gpt-5-5-pro`, `claude-fable-5`, `step-3-5-flash`, `nemotron-3-super`, `qwen25-coder-7b`, `deepseek-v4-pro`, `mimo-v2-flash`, `glm-5-turbo`, `gpt-5-4`, `qwen3-6-35b-moe`, `gemma-4-26b-moe`, `llama-4-scout`, `mimo-v2-pro`, `step-3-7-flash`, `muse-spark`, `qwen3-5-9b`, `gpt-5-5`, `glm-5`, `qwen3-32b`, `gemini-3-1-flash`, `grok-4-3`, `kimi-k2-6`, `claude-mythos-5`, `mimo-v2-5-pro`, `opus-4-7`, `qwen3-235b`, `minimax-m2-7`, `glm-4-5-air`, `qwen25-coder-32b`, `nemotron-3-ultra`, `claude-haiku-4-5`, `gemini-3-5-flash`, `qwen3-7-max`, `gemma-4-31b`, `gemini-3-1-pro`, `gemma-3-27b`, `qwen3-6-27b`
...
- gemini-3-1-flash.hle: winner={'value': 34.52, 'trustScore': 0.4853, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- gemini-3-1-pro.tau2: winner={'value': 76.5, 'trustScore': 0.4901, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- gemma-3-27b.gpqa: winner={'value': 42.4, 'trustScore': 0.4889, 'tier': 'I', 'verifications': 23, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-26b-moe.gpqa: winner={'value': 82.3, 'trustScore': 0.4808, 'tier': 'I', 'verifications': 21, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-26b-moe.cfElo: winner={'value': 1718.0, 'trustScore': 0.4808, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-26b-moe.hle: winner={'value': 22.0, 'trustScore': 0.4971, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
...
- gemma-4-31b.gpqa: winner={'value': 84.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 26, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-31b.tau2: winner={'value': 86.4, 'trustScore': 0.4901, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- gemma-4-31b.hle: winner={'value': 22.95, 'trustScore': 0.4914, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- gemma-4-31b.sweV: winner={'value': 64.0, 'trustScore': 0.478, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- gemma-4-e2b.gpqa: winner={'value': 43.4, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-e2b.aime26: winner={'value': 37.5, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-e4b.gpqa: winner={'value': 58.6, 'trustScore': 0.4808, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gemma-4-e4b.mmluPro: winner={'value': 69.4, 'trustScore': 0.4808, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- llama-4-maverick.gpqa: winner={'value': 69.8, 'trustScore': 0.4808, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- llama-4-maverick.sweV: winner={'value': 76.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- llama-4-maverick.lcb: winner={'value': 43.4, 'trustScore': 0.4846, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- llama-4-scout.gpqa: winner={'value': 57.21, 'trustScore': 0.4808, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- llama-4-scout.lcb: winner={'value': 32.8, 'trustScore': 0.4112, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- llama-4-scout.sweV: winner={'value': 58.24, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- llama-4-scout.aaIdx: winner={'value': 10.04, 'trustScore': 0.4995, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- muse-spark.aaIdx: winner={'value': 43.0, 'trustScore': 0.4995, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- muse-spark.aaCoding: winner={'value': 47.5, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- muse-spark.aaAgentic: winner={'value': 28.69, 'trustScore': 0.4931, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- opus-4-7.sweV: winner={'value': 87.6, 'trustScore': 0.478, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- opus-4-7.swePro: winner={'value': 64.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- opus-4-7.gpqa: winner={'value': 94.2, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
...
- opus-4-7.mmluPro: winner={'value': 89.87, 'trustScore': 0.5, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- opus-4-7.lcb: winner={'value': 72.2, 'trustScore': 0.425, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-22'} (severity=red, ΔNone)
- sonnet-4-6.sweV: winner={'value': 79.6, 'trustScore': 0.478, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- sonnet-4-6.swePro: winner={'value': 40.2, 'trustScore': 0.425, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- sonnet-4-6.tau2: winner={'value': 91.7, 'trustScore': 0.4753, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- sonnet-4-6.arcAgi2: winner={'value': 58.3, 'trustScore': 0.425, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- sonnet-4-6.gpqa: winner={'value': 74.1, 'trustScore': 0.4717, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- sonnet-4-6.hle: winner={'value': 51.0, 'trustScore': 0.425, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- sonnet-4-6.tb2: winner={'value': 59.1, 'trustScore': 0.425, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- sonnet-4-6.lcb: winner={'value': 80.0, 'trustScore': 0.4112, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- sonnet-4-6.aime26: winner={'value': 63.3, 'trustScore': 0.425, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- sonnet-4-6.mmluPro: winner={'value': 79.2, 'trustScore': 0.4853, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-haiku-4-5.sweV: winner={'value': 73.3, 'trustScore': 0.5, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-haiku-4-5.gpqa: winner={'value': 67.2, 'trustScore': 0.425, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-haiku-4-5.tau2: winner={'value': 83.1, 'trustScore': 0.4753, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
...
- claude-haiku-4-5.lcb: winner={'value': 61.5, 'trustScore': 0.425, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-opus-4-8.hle: winner={'value': 49.8, 'trustScore': 0.4971, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-opus-4-8.aaIdx: winner={'value': 55.69, 'trustScore': 0.4995, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-fable-5.hle: winner={'value': 64.5, 'trustScore': 0.4751, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-fable-5.lcb: winner={'value': 89.78, 'trustScore': 0.5, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- claude-mythos-5.sweV: winner={'value': 93.9, 'trustScore': 0.5, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- qwen3-6-27b.sweV: winner={'value': 77.2, 'trustScore': 0.478, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-27b.lcb: winner={'value': 83.9, 'trustScore': 0.4112, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-27b.gpqa: winner={'value': 87.8, 'trustScore': 0.3667, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-27b.aaCoding: winner={'value': 53.72, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-27b.aaAgentic: winner={'value': 27.03, 'trustScore': 0.4931, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-max.tb2: winner={'value': 65.4, 'trustScore': 0.4985, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- qwen3-235b.lcb: winner={'value': 74.48, 'trustScore': 0.4838, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-235b.gpqa: winner={'value': 81.1, 'trustScore': 0.4125, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-235b.aime26: winner={'value': 92.3, 'trustScore': 0.3453, 'tier': 'S', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-235b.bfcl: winner={'value': 70.8, 'trustScore': 0.425, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- qwen3-235b.aaIdx: winner={'value': 30.0, 'trustScore': 0.4995, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-32b.lcb: winner={'value': 54.54, 'trustScore': 0.4846, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- qwen3-32b.aaIdx: winner={'value': 76.4, 'trustScore': 0.4749, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-6-35b-moe.tb2: winner={'value': 51.5, 'trustScore': 0.4853, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-35b-moe.lcb: winner={'value': 80.4, 'trustScore': 0.4112, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- qwen3-6-35b-moe.gpqa: winner={'value': 86.0, 'trustScore': 0.2888, 'tier': 'S', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-35b-moe.mcpA: winner={'value': 37.0, 'trustScore': 0.3426, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-35b-moe.tbHard: winner={'value': 43.94, 'trustScore': 0.498, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen3-6-35b-moe.aaCoding: winner={'value': 41.88, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-35b-moe.aaAgentic: winner={'value': 21.41, 'trustScore': 0.4931, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-plus.aaIdx: winner={'value': 39.56, 'trustScore': 0.4995, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-plus.aaCoding: winner={'value': 54.53, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-6-plus.aaAgentic: winner={'value': 27.55, 'trustScore': 0.4931, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-coder-480b.sweV: winner={'value': 69.6, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-coder-480b.swePro: winner={'value': 38.7, 'trustScore': 0.425, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-coder-480b.gpqa: winner={'value': 84.2, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-coder-480b.mmluPro: winner={'value': 93.4, 'trustScore': 0.4719, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-coder-480b.lcb: winner={'value': 68.0, 'trustScore': 0.4119, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-18'} (severity=red, ΔNone)
...
- qwen3-coder-30b.sweV: winner={'value': 51.25, 'trustScore': 0.4692, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- qwen3-coder-next.swePro: winner={'value': 44.3, 'trustScore': 0.425, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- qwen3-coder-next.lcb: winner={'value': 68.57, 'trustScore': 0.4838, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen25-coder-32b.lcb: winner={'value': 48.69, 'trustScore': 0.4838, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- qwen25-coder-32b.mmluPro: winner={'value': 78.2, 'trustScore': 0.4719, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen25-coder-14b.lcb: winner={'value': 37.6, 'trustScore': 0.4125, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen25-coder-14b.gpqa: winner={'value': 36.8, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- qwen25-coder-7b.lcb: winner={'value': 37.6, 'trustScore': 0.2582, 'tier': 'S', 'verifications': 3, 'latestDate': '2026-05-28'} (severity=red, ΔNone)
- qwen25-coder-7b.gpqa: winner={'value': 35.6, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- deepseek-v3-2.sweV: winner={'value': 67.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v3-2.gpqa: winner={'value': 82.4, 'trustScore': 0.4125, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-06'} (severity=red, ΔNone)
- deepseek-v3-2.mmluPro: winner={'value': 85.0, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v3-2.lcb: winner={'value': 74.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v4-flash.sweV: winner={'value': 79.0, 'trustScore': 0.478, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v4-flash.lcb: winner={'value': 91.44, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v4-flash.gpqa: winner={'value': 88.35, 'trustScore': 0.4853, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v4-flash.aaIdx: winner={'value': 40.28, 'trustScore': 0.4995, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v4-pro.sweV: winner={'value': 80.6, 'trustScore': 0.478, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- deepseek-v4-pro.lcb: winner={'value': 93.5, 'trustScore': 0.4797, 'tier': 'I', 'verifications': 19, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v4-pro.gpqa: winner={'value': 90.1, 'trustScore': 0.4314, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- deepseek-v4-pro.aaIdx: winner={'value': 44.27, 'trustScore': 0.4995, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- kimi-k2-6.tb2: winner={'value': 66.7, 'trustScore': 0.4182, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-6.lcb: winner={'value': 89.6, 'trustScore': 0.4125, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-6.gpqa: winner={'value': 90.54, 'trustScore': 0.4853, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- kimi-k2-6.hle: winner={'value': 54.0, 'trustScore': 0.4226, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gpt-5-4.swePro: winner={'value': 59.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gpt-5-4.gpqa: winner={'value': 92.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- gpt-5-4.aaCoding: winner={'value': 71.05, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gpt-5-4.arcAgi2: winner={'value': 73.3, 'trustScore': 0.4853, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gpt-5-4.hle: winner={'value': 39.8, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- gpt-5-5.sweV: winner={'value': 88.59, 'trustScore': 0.5, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gpt-5-5.hle: winner={'value': 41.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 15, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gpt-5-5.mrcr: winner={'value': 74.0, 'trustScore': 0.4182, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gpt-5-5.mmluPro: winner={'value': 92.35, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- gpt-5-5.aime26: winner={'value': 87.9, 'trustScore': 0.4622, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-05-30'} (severity=red, ΔNone)
- gpt-5-4-mini.aaCoding: winner={'value': 56.08, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- gpt-5-4-nano.aaCoding: winner={'value': 56.07, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- gpt-5-5-pro.hle: winner={'value': 43.1, 'trustScore': 0.4218, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- glm-5.tau2: winner={'value': 98.12, 'trustScore': 0.4914, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- glm-5.hle: winner={'value': 30.5, 'trustScore': 0.4933, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- glm-5.gpqa: winner={'value': 86.6, 'trustScore': 0.4314, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- glm-5-1.swePro: winner={'value': 58.4, 'trustScore': 0.4808, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- glm-5-1.gpqa: winner={'value': 86.23, 'trustScore': 0.4853, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- glm-4-7.sweV: winner={'value': 73.75, 'trustScore': 0.478, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- glm-4-7.tau2: winner={'value': 87.4, 'trustScore': 0.4753, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- glm-4-5-air.tau2: winner={'value': 78.11, 'trustScore': 0.5, 'tier': 'I', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-1.sweV: winner={'value': 74.0, 'trustScore': 0.4808, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- minimax-m2-1.swePro: winner={'value': 36.81, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-1.gpqa: winner={'value': 82.88, 'trustScore': 0.4853, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- minimax-m2-1.hle: winner={'value': 22.2, 'trustScore': 0.4971, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- minimax-m2-1.lcb: winner={'value': 86.0, 'trustScore': 0.4125, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
- minimax-m2-5.sweV: winner={'value': 80.2, 'trustScore': 0.4933, 'tier': 'I', 'verifications': 20, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-5.swePro: winner={'value': 55.49, 'trustScore': 0.5, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-5.gpqa: winner={'value': 85.1, 'trustScore': 0.4914, 'tier': 'I', 'verifications': 17, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-5.hle: winner={'value': 19.37, 'trustScore': 0.4971, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-5.mmluPro: winner={'value': 74.0, 'trustScore': 0.425, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
...
- minimax-m2-7.gpqa: winner={'value': 86.97, 'trustScore': 0.4853, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-7.hle: winner={'value': 28.1, 'trustScore': 0.4971, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-7.tbHard: winner={'value': 39.4, 'trustScore': 0.498, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-7.tau2: winner={'value': 84.8, 'trustScore': 0.4901, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- minimax-m2-7.mmluPro: winner={'value': 82.0, 'trustScore': 0.4719, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-16'} (severity=yellow, ΔNone)
- minimax-m3.aaIdx: winner={'value': 44.0, 'trustScore': 0.4995, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- step-3-5-flash.sweV: winner={'value': 74.4, 'trustScore': 0.5, 'tier': 'I', 'verifications': 14, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- step-3-5-flash.tb2: winner={'value': 51.0, 'trustScore': 0.4237, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- step-3-5-flash.gpqa: winner={'value': 83.5, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 11, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- step-3-7-flash.sweV: winner={'value': 74.4, 'trustScore': 0.3386, 'tier': 'S', 'verifications': 2, 'latestDate': '2026-06-06'} (severity=yellow, ΔNone)
- step-3-7-flash.tb2: winner={'value': 59.5, 'trustScore': 0.3426, 'tier': 'S', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- step-3-7-flash.gpqa: winner={'value': 77.8, 'trustScore': 0.4855, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- mistral-large-3.gpqa: winner={'value': 67.98, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- mistral-large-3.lcb: winner={'value': 34.4, 'trustScore': 0.4846, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- mistral-large-3.tau2: winner={'value': 70.2, 'trustScore': 0.4901, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- codestral.swePro: winner={'value': 1.51, 'trustScore': 0.5, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- codestral.gpqa: winner={'value': 78.6, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- mistral-medium-3-5.sweV: winner={'value': 77.6, 'trustScore': 0.4808, 'tier': 'I', 'verifications': 18, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mistral-medium-3-5.aaAgentic: winner={'value': 19.0, 'trustScore': 0.4931, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
...
- mistral-medium-3-5.hle: winner={'value': 9.5, 'trustScore': 0.4971, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=yellow, ΔNone)
- mistral-medium-3-5.tbHard: winner={'value': 20.45, 'trustScore': 0.498, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- mistral-medium-3-5.tau2: winner={'value': 91.4, 'trustScore': 0.4125, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-16'} (severity=yellow, ΔNone)
- mistral-small-4.gpqa: winner={'value': 71.2, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mimo-v2-flash.gpqa: winner={'value': 83.83, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 12, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mimo-v2-flash.hle: winner={'value': 22.1, 'trustScore': 0.3426, 'tier': 'S', 'verifications': 7, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mimo-v2-flash.lcb: winner={'value': 80.6, 'trustScore': 0.425, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mimo-v2-flash.tb2: winner={'value': 38.5, 'trustScore': 0.492, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mimo-v2-flash.aaIdx: winner={'value': 23.07, 'trustScore': 0.4995, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- mimo-v2-pro.sweV: winner={'value': 78.0, 'trustScore': 0.478, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mimo-v2-pro.gpqa: winner={'value': 87.0, 'trustScore': 0.4914, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- mimo-v2-pro.tau2: winner={'value': 95.01, 'trustScore': 0.4901, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mimo-v2-pro.tb2: winner={'value': 86.7, 'trustScore': 0.4853, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- mimo-v2-5-pro.gpqa: winner={'value': 66.7, 'trustScore': 0.2455, 'tier': 'S', 'verifications': 5, 'latestDate': '2026-05-22'} (severity=red, ΔNone)
- mimo-v2-5-pro.hle: winner={'value': 33.8, 'trustScore': 0.4971, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mimo-v2-5-pro.tau2: winner={'value': 72.9, 'trustScore': 0.4166, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-05-27'} (severity=red, ΔNone)
- mimo-v2-5-pro.aaCoding: winner={'value': 45.5, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mimo-v2-5-pro.lcb: winner={'value': 76.2, 'trustScore': 0.4015, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-15'} (severity=yellow, ΔNone)
- mimo-v2-5-pro.mmluPro: winner={'value': 68.5, 'trustScore': 0.3347, 'tier': 'S', 'verifications': 1, 'latestDate': '2026-06-07'} (severity=red, ΔNone)
- nemotron-3-super.sweV: winner={'value': 60.47, 'trustScore': 0.4933, 'tier': 'I', 'verifications': 20, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- nemotron-3-super.gpqa: winner={'value': 79.27, 'trustScore': 0.4889, 'tier': 'I', 'verifications': 16, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- nemotron-3-super.lcb: winner={'value': 81.1, 'trustScore': 0.4853, 'tier': 'I', 'verifications': 10, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- nemotron-3-super.tau2: winner={'value': 67.8, 'trustScore': 0.4901, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- nemotron-3-super.tbHard: winner={'value': 29.0, 'trustScore': 0.498, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- nemotron-3-nano-omni.lcb: winner={'value': 68.25, 'trustScore': 0.4339, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- nemotron-3-nano-omni.tau2: winner={'value': 49.04, 'trustScore': 0.4694, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- nemotron-3-nano-omni.aime26: winner={'value': 89.9, 'trustScore': 0.4933, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
...
- qwen3-5-9b.gpqa: winner={'value': 81.7, 'trustScore': 0.4914, 'tier': 'I', 'verifications': 13, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-5-9b.mmluPro: winner={'value': 82.5, 'trustScore': 0.4684, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-5-9b.aaIdx: winner={'value': 24.97, 'trustScore': 0.4995, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- qwen3-5-9b.aaCoding: winner={'value': 25.3, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 1, 'latestDate': '2026-06-27'} (severity=yellow, ΔNone)
- qwen3-5-9b.aaAgentic: winner={'value': 37.42, 'trustScore': 0.4931, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-5-9b.tau2: winner={'value': 86.84, 'trustScore': 0.4901, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-24'} (severity=red, ΔNone)
- qwen3-5-9b.lcb: winner={'value': 65.6, 'trustScore': 0.4838, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-10'} (severity=red, ΔNone)
- qwen3-7-max.aaIdx: winner={'value': 45.99, 'trustScore': 0.4995, 'tier': 'I', 'verifications': 2, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- grok-4-20.tb2: winner={'value': 47.1, 'trustScore': 0.5, 'tier': 'I', 'verifications': 4, 'latestDate': '2026-06-15'} (severity=red, ΔNone)
- grok-4-20.sweV: winner={'value': 77.06, 'trustScore': 0.5, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- grok-4-20.gpqa: winner={'value': 88.02, 'trustScore': 0.4788, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- grok-4-20.lcb: winner={'value': 79.28, 'trustScore': 0.4846, 'tier': 'I', 'verifications': 9, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- grok-4-3.gpqa: winner={'value': 90.08, 'trustScore': 0.4853, 'tier': 'I', 'verifications': 6, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- grok-4-3.hle: winner={'value': 53.0, 'trustScore': 0.4971, 'tier': 'I', 'verifications': 5, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- grok-4-3.sweV: winner={'value': 79.44, 'trustScore': 0.478, 'tier': 'I', 'verifications': 8, 'latestDate': '2026-06-27'} (severity=red, ΔNone)
- mimo-v2-flash.aaCoding: winner={'value': 25.81, 'trustScore': 0.4969, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-16'} (severity=red, ΔNone)
- mimo-v2-flash.aaAgentic: winner={'value': 47.34, 'trustScore': 0.4931, 'tier': 'I', 'verifications': 3, 'latestDate': '2026-06-16'} (severity=red, ΔNone)

### Gaps (343 entries — agent:343 orchestrator:0 — see data/known-gaps.json or next refresh)
...
- `gemma-4-26b-moe.swePro` *(agent)*: agent surveyed; value unavailable
- ... and 337 more
